...
-- bug was fixed (row 39, migration 20260925160500), a member with NO
...
-- 20260925160600): changing the DEFAULT applied to a NEW row (or a row whose
...
-- `20260925160600_a_daily_summary_can_reach_a_phone.sql`'s own section 2 now
