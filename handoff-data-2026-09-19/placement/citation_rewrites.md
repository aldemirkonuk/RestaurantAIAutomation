...
## GENERIC-DOSSIER-UNVERIFIED (143)

A 06-pages/08-softwares/pr-audits/decisions/foundation/code dossier citing a bare register line number with no named concept. ADR 0166 validated this CLASS's file-count, not each line's current accuracy. Two concrete drift cases were found and fully resolved in this pass (the iCal cluster and cellar-format.ts's market-price mis-citation) proving this class needs a real content-diff, not a line-copy, at execution time. Default rewrite: re-derive the citation from the item's actual current content at execution time, or drop it if the citing sentence's own claim is already stale/closed.

**2026-09-19, second pass:** 11 more references (0141:114, 0141:182, 0162:115, doorOutbox.ts:71, and the 7-file "orders wire" item-2 cluster) were pulled out of this bucket into EXPLICIT/MANUAL after an independent verifier named them specifically -- these were not drift, just a classifier miss (a multi-line wrap the line-scoped grep didn't follow, and two named-concept quotes the first pass's regex didn't catch). One closely-neighboring citation, `order-recurrence.service.ts:22`, was checked by hand and confirmed to name a genuinely different, still-open defect (an `auto_approve` schedule with no seal/threshold check) -- it stays here, not swept in by proximity. 154 -> 143.

<details><summary>Full reference list (143)</summary>


- `.planning/06-pages/PAGE-CONTRACT.md:30`
- `.planning/06-pages/PAGES-MAP.md:134`
- `.planning/06-pages/RETIRED.md:114`
- `.planning/06-pages/RETIRED.md:120`
- `.planning/06-pages/RETIRED.md:123`
- `.planning/06-pages/dashboard.md:354`
- `.planning/06-pages/dashboard.md:377`
- `.planning/06-pages/dashboard.md:437`
- `.planning/06-pages/dashboard.md:439`
- `.planning/06-pages/dashboard.md:517`
- `.planning/06-pages/dashboard.md:519`
- `.planning/06-pages/documents-reports.md:366`
- `.planning/06-pages/inventory.md:216`
- `.planning/06-pages/inventory.md:220`
- `.planning/06-pages/inventory.md:227`
- `.planning/06-pages/inventory.md:237`
- `.planning/06-pages/inventory.md:253`
- `.planning/06-pages/inventory.md:258`
- `.planning/06-pages/inventory.md:335`
- `.planning/06-pages/invite-landing.md:71`
- `.planning/06-pages/logs.md:219`
- `.planning/06-pages/logs.md:328`
- `.planning/06-pages/no-access.md:63`
- `.planning/06-pages/no-access.md:111`
- `.planning/06-pages/notifications.md:980`
- `.planning/06-pages/notifications.md:985`
- `.planning/06-pages/notifications.md:1116`
- `.planning/06-pages/notifications.md:1118`
- `.planning/06-pages/notifications.md:1163`
- `.planning/06-pages/notifications.md:1165`
- `.planning/06-pages/orders.md:100`
- `.planning/06-pages/orders.md:102`
- `.planning/06-pages/orders.md:369`
- `.planning/06-pages/orders.md:526`
- `.planning/06-pages/orders.md:682`
- `.planning/06-pages/orders.md:803`
- `.planning/06-pages/orders.md:1043`
- `.planning/06-pages/privacy.md:81`
- `.planning/06-pages/privacy.md:137`
- `.planning/06-pages/promotions.md:82`
- `.planning/06-pages/promotions.md:184`
- `.planning/06-pages/providers.md:547`
- `.planning/06-pages/receipts.md:243`
- `.planning/06-pages/receipts.md:246`
- `.planning/06-pages/receipts.md:272`
- `.planning/06-pages/receipts.md:331`
- `.planning/06-pages/receipts.md:332`
- `.planning/06-pages/receipts.md:588`
- `.planning/06-pages/receipts.md:590`
- `.planning/06-pages/receiving-door.md:143`
- `.planning/06-pages/receiving-door.md:154`
- `.planning/06-pages/recommendations-catalog.md:119`
- `.planning/06-pages/recommendations.md:944`
- `.planning/06-pages/recommendations.md:1076`
- `.planning/06-pages/recommendations.md:1110`
- `.planning/06-pages/recommendations.md:1235`
- `.planning/06-pages/reports.md:898`
- `.planning/06-pages/reports.md:998`
- `.planning/06-pages/reports.md:1000`
- `.planning/06-pages/reports.md:1051`
- `.planning/06-pages/reports.md:1053`
- `.planning/06-pages/reports.md:1157`
- `.planning/06-pages/simpos-terminal.md:114`
- `.planning/06-pages/simpos-terminal.md:152`
- `.planning/06-pages/simpos-terminal.md:236`
- `.planning/06-pages/sommelier.md:91`
- `.planning/06-pages/sommelier.md:98`
- `.planning/06-pages/sommelier.md:131`
- `.planning/06-pages/studio-certify.md:77`
- `.planning/06-pages/studio-certify.md:199`
- `.planning/06-pages/studio.md:90`
- `.planning/06-pages/team.md:412`
- `.planning/06-pages/team.md:563`
- `.planning/06-pages/team.md:564`
- `.planning/06-pages/wines.md:1200`
- `.planning/06-pages/wines.md:1213`
- `.planning/06-pages/wines.md:1215`
- `.planning/06-pages/wines.md:1218`
- `.planning/06-pages/wines.md:1535`
- `.planning/07-reference/pr-audits/354-987fff01.md:46`
- `.planning/07-reference/pr-audits/354-987fff01.md:47`
- `.planning/07-reference/pr-audits/354-b0f0a514.md:54`
- `.planning/08-softwares/inventory-command.md:155`
- `.planning/08-softwares/inventory-command.md:172`
- `.planning/08-softwares/pos-bridge.md:235`
- `.planning/08-softwares/pos-bridge.md:261`
- `.planning/08-softwares/receipts-invoice-match.md:50`
- `.planning/08-softwares/receipts-invoice-match.md:149`
- `.planning/08-softwares/receipts-invoice-match.md:308`
- `.planning/08-softwares/receipts-invoice-match.md:331`
- `.planning/08-softwares/wine-library-sommelier.md:105`
- `.planning/decisions/0005-v3-to-v0-version-reset.md:16`
- `.planning/decisions/0005-v3-to-v0-version-reset.md:21`
- `.planning/decisions/0005-v3-to-v0-version-reset.md:36`
- `.planning/decisions/0010-gemini-model-retirement.md:7`
- `.planning/decisions/0018-p2-plan-of-record.md:66`
- `.planning/decisions/0019-p2-build-scope.md:24`
- `.planning/decisions/0032-vault-cleanup-cut-line.md:34`
- `.planning/decisions/0032-vault-cleanup-cut-line.md:74`
- `.planning/decisions/0032-vault-cleanup-cut-line.md:121`
- `.planning/decisions/0044-mudavym-implementation-kickoff.md:138`
- `.planning/decisions/0045-rivet-m-and-full-go.md:153`
- `.planning/decisions/0064-a-fitted-value-is-a-prediction-not-a-memory.md:7`
- `.planning/decisions/0064-a-fitted-value-is-a-prediction-not-a-memory.md:34`
- `.planning/decisions/0064-a-fitted-value-is-a-prediction-not-a-memory.md:132`
- `.planning/decisions/0103-a-delivery-is-agreed-before-it-is-verified.md:198`
- `.planning/decisions/0103-a-delivery-is-agreed-before-it-is-verified.md:279`
- `.planning/decisions/0103-a-delivery-is-agreed-before-it-is-verified.md:325`
- `.planning/decisions/0103-a-delivery-is-agreed-before-it-is-verified.md:335`
- `.planning/decisions/0103-a-delivery-is-agreed-before-it-is-verified.md:338`
- `.planning/decisions/0103-a-delivery-is-agreed-before-it-is-verified.md:339`
- `.planning/decisions/0103-a-delivery-is-agreed-before-it-is-verified.md:350`
- `.planning/decisions/0104-every-incoming-document-renders-as-one-canonical-mudavym-document.md:696`
- `.planning/decisions/0104-every-incoming-document-renders-as-one-canonical-mudavym-document.md:698`
- `.planning/decisions/0104-every-incoming-document-renders-as-one-canonical-mudavym-document.md:705`
- `.planning/decisions/0105-a-pos-connection-is-a-row-not-an-env-var.md:141`
- `.planning/decisions/0129-below-par-is-strictly-below-par.md:16`
- `.planning/decisions/0139-an-oauth-sign-in-binds-to-a-linked-account.md:226`
- `.planning/decisions/0140-the-door-outbox-keeps-the-receipt-and-claims-nothing-it-cannot-prove.md:63`
- `.planning/decisions/0166-the-defect-register-retires-and-its-items-live-by-kind.md:9`
- `.planning/decisions/0166-the-defect-register-retires-and-its-items-live-by-kind.md:18`
- `.planning/decisions/0166-the-defect-register-retires-and-its-items-live-by-kind.md:60`
- `.planning/decisions/0166-the-defect-register-retires-and-its-items-live-by-kind.md:64`
- `.planning/decisions/0166-the-defect-register-retires-and-its-items-live-by-kind.md:206`
- `.planning/decisions/OPEN-DECISIONS.md:49`
- `.planning/decisions/OPEN-DECISIONS.md:83`
- `.planning/decisions/README.md:89`
- `.planning/decisions/README.md:152`
- `.planning/decisions/README.md:154`
- `.planning/foundation/README.md:273`
- `.planning/foundation/teams/corporate.md:182`
- `apps/api-gateway/src/auth/dev-bypass-verified.spec.ts:40`
- `apps/api-gateway/src/auth/dev-bypass.util.ts:45`
- `apps/api-gateway/src/procurement/canonical/canonical-document.service.spec.ts:415`
- `apps/api-gateway/src/procurement/canonical/canonical-invariants.spec.ts:467`
- `apps/api-gateway/src/procurement/canonical/delivery-mock.ts:15`
- `apps/api-gateway/src/procurement/canonical/delivery-stock.service.ts:17`
- `apps/api-gateway/src/procurement/canonical/from-parsed-document.spec.ts:341`
- `apps/api-gateway/src/procurement/documents/document-extractor.spec.ts:559`
- `apps/api-gateway/src/procurement/documents/document-intake.service.spec.ts:155`
- `apps/api-gateway/src/procurement/order-recurrence.service.ts:22`
- `apps/api-gateway/src/procurement/receiving.service.ts:538`
- `apps/web/src/components/documents/__tests__/canonical-sections.test.tsx:499`
...
- **OPEN-DECISIONS.md:14** — inside a frozen historical note about a past OD-57..63 renumbering.
  Leave as-is; it is a closed historical record of an event, not a live pointer (same convention
  CLAUDE.md already applies to archive/*.md and v2.0-MILESTONE-AUDIT.md).
...
## __44.2_CLASS__ — bare section-level mentions (3 references)
...
## __ORDERS_WIRE_ITEM2__ — a second classifier miss, resolved as one (7 references)

Added 2026-09-19, second pass, after an independent verifier named this exact 7-file cluster by hand.
All 7 quote `.planning/v3.0-TECH-DEBT.md "The orders wire" item 2` by name and section title —
...
through `approveOrder` with no seal and no threshold check. Left in GENERIC-DOSSIER-UNVERIFIED,
untouched; swept in by proximity it would have been a wrong, undisclosed merge.
