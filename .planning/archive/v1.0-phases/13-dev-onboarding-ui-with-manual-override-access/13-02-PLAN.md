...
must_haves:
  truths:
    ...
    - "GET /api/v1/studio/metrics returns flat response: total_overrides, pending_queue, auto_promoted, accepted_overrides, rejected_overrides, acceptance_rate, avg_approval_latency_hours, active_contributors, computed_at"
...
def get_studio_metrics(
    ...
    try:
        ...
        # Active contributors: distinct actors with any override in the last 30 days
        ...
        return {
            ...
            "avg_approval_latency_hours": round(approval_latency_p50_hours, 4),
