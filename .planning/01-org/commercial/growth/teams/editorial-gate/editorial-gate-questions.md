...
updated: 2026-08-24
open_questions: 0
links: ["[[editorial-gate-charter]]", "[[editorial-gate-agenda-full]]", "[[architecture-review-charter]]", "[[red-team-charter]]", "[[decision-office-charter]]"]
---

# Editorial Gate — Questions & Findings
...
**ID format.** `EDI-Q<n>` for this unit's own questions; advisory keeps its own
