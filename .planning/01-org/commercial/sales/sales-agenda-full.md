...
- **Evidence.** [[outbound-engine-charter]] §Entry trigger (two conditions, both unmet);
  ...
  `.planning/decisions/OPEN-DECISIONS.md:54` (OD-77), which says in the founder's own
...
- **Evidence.** OD-77 (`OPEN-DECISIONS.md:54`) is founder-deferred, blocks OD-78, and its
