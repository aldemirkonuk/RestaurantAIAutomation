...
updated: 2026-08-24
open_questions: 0
links: ["[[inference-cost-charter]]", "[[inference-cost-agenda-full]]", "[[architecture-review-charter]]", "[[red-team-charter]]", "[[decision-office-charter]]"]
---

# Inference Cost — Questions & Findings
...
**ID format.** `INF-Q<n>` for this unit's own questions; advisory keeps its own
