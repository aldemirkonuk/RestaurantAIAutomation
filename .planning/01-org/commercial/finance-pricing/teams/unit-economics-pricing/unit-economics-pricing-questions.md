...
updated: 2026-08-24
open_questions: 0
links: ["[[unit-economics-pricing-charter]]", "[[unit-economics-pricing-agenda-full]]", "[[architecture-review-charter]]", "[[red-team-charter]]", "[[decision-office-charter]]"]
---

# Unit Economics & Pricing — Questions & Findings
...
**ID format.** `UNI-Q<n>` for this unit's own questions; advisory keeps its own
