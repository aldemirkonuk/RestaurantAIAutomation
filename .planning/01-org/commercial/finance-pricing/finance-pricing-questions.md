...
updated: 2026-08-24
open_questions: 0
links: ["[[finance-pricing-charter]]", "[[finance-pricing-agenda-full]]", "[[architecture-review-charter]]", "[[red-team-charter]]", "[[decision-office-charter]]"]
---

# Finance & Pricing (sub-layer) — Questions & Findings
...
**ID format.** `FIN-Q<n>` for this unit's own questions; advisory keeps its own
