...
| 5 | *"OD-11 is open; any column F1 adds is a bridge"* | **OD-11 is resolved** — Path C, [[0008-nf-column-contract]], 2026-08-24, "P1 unblocked" (`OPEN-DECISIONS.md:140`). [[finance-pricing-charter]]:160 still calls it open; charters are not this wave's to edit (§8.4) | register read |
