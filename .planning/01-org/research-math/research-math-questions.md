...
updated: 2026-08-24
open_questions: 0
links: ["[[research-math-charter]]", "[[research-math-agenda-full]]", "[[architecture-review-charter]]", "[[red-team-charter]]", "[[decision-office-charter]]"]
---

# Research & Math — Questions & Findings
...
**ID format.** `RES-Q<n>` for this unit's own questions; advisory keeps its own
