...
updated: 2026-08-24
open_questions: 0
links: ["[[harness-model-routing-charter]]", "[[harness-model-routing-agenda-full]]", "[[architecture-review-charter]]", "[[red-team-charter]]", "[[decision-office-charter]]"]
---

# Harness & Model Routing — Questions & Findings
...
**ID format.** `HAR-Q<n>` for this unit's own questions; advisory keeps its own
