...
|---|---|---|
| **The OD-03 bake-off on this repo's own workloads** | A truncated bake-off produces a pick from repute with a table attached — the thing `OD-03 (OPEN-DECISIONS.md:24)` explicitly forbids | [[harness-model-routing-charter]] |
