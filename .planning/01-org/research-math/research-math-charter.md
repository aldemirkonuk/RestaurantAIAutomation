...
seam "OD-21", but `OPEN-DECISIONS.md:152` already assigns OD-21 to the Obsidian
...
| Ref | Fork |
|---|---|
| **OD-03** | Orchestration base — must be decided by a bake-off on this repo's own workloads. `OPEN-DECISIONS.md:30` already says *"No pick from repute."* [[harness-model-routing-charter]] owns executing that |
