...
| **The company story told to customers** — the deck's craft, the case study, the demo script, the one-sentence pitch as a produced artifact | [[media-brand-charter]] → [[narrative-collateral-charter]] (M2) | Media & Brand owns the **craft of the artifact and the customer-facing story**; Strategy owns **the claim and the investor audience**. `commercial.md:512-513` states the same boundary from the other side: *"Corporate → Strategy & Fundraising owns the YC path and the process. This team owns the craft of the artifact, never the decision to apply."* Two units, one sentence, opposite responsibilities: M2 makes every artifact lead with it; Strategy decides what it says and whether it is true |
