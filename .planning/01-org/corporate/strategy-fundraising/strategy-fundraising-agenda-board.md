...
OD-23 (`OPEN-DECISIONS.md:32`) records that **no ADR sets any price**, so calling $20–50/mo
...
**The block lifted on 2026-08-26** — OD-33 (`OPEN-DECISIONS.md:37`) settled the count at
...
OD-23 sits at `OPEN-DECISIONS.md:32`, not `:27`. A non-empty result here is the department
...
- [ ] **2026-08-28 — still open. Day 4 of this department's watch, and the entry moved
      under us.** OD-23 (`OPEN-DECISIONS.md:32`) now records three corrections: no ADR sets
...
- [ ] **OD-23** — the revenue target, its price, and its source document. **Founder call**, unresolved (`OPEN-DECISIONS.md:32`)
...
- [ ] **OD-19** — the residual unguarded-by-omission routes (`OPEN-DECISIONS.md:31`); it is what claim #9 (*"Security complete"*) must be weakened against
- [ ] **375 vs 573** — **closed** by OD-33 (`OPEN-DECISIONS.md:37`) on 2026-08-26. Carried here only until STR-10 removes the block from this vault's three remaining mentions
