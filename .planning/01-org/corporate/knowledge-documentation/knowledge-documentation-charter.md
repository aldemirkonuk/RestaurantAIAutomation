...
**Open forks touching this department:** OD-01 (`OPEN-DECISIONS.md:86`) — now the only one
...
it was open. The register has since moved both into Resolved — OD-21 (`OPEN-DECISIONS.md:151`)
locked the Obsidian structure, and OD-08 (`OPEN-DECISIONS.md:150`) was folded into it — so
