...
it was open. The register has since moved both into Resolved — OD-21 (`OPEN-DECISIONS.md:127`)
locked the Obsidian structure, and OD-08 (`OPEN-DECISIONS.md:126`) was folded into it — so
