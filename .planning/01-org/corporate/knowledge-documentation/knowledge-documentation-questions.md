...
updated: 2026-08-24
open_questions: 0
links: ["[[knowledge-documentation-charter]]", "[[knowledge-documentation-agenda-full]]", "[[architecture-review-charter]]", "[[red-team-charter]]", "[[decision-office-charter]]"]
---

# Knowledge & Documentation — Questions & Findings
...
**ID format.** `KNO-Q<n>` for this unit's own questions; advisory keeps its own
