...
| Deciding OD-01's target shape | The founder | We execute the restructure; we do not pick it (`OPEN-DECISIONS.md:24`) |
...
**Open fork:** OD-01 (`OPEN-DECISIONS.md:24`). Founder picks the target shape;
