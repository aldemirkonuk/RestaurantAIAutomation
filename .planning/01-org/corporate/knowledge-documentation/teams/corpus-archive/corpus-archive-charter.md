...
| Deciding OD-01's target shape | The founder | We execute the restructure; we do not pick it (`OPEN-DECISIONS.md:26`) |
...
**Open fork:** OD-01 (`OPEN-DECISIONS.md:26`). Founder picks the target shape;
