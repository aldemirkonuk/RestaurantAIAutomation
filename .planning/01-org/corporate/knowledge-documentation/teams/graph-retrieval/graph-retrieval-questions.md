...
updated: 2026-08-24
open_questions: 0
links: ["[[graph-retrieval-charter]]", "[[graph-retrieval-agenda-full]]", "[[architecture-review-charter]]", "[[red-team-charter]]", "[[decision-office-charter]]"]
---

# Graph & Retrieval — Questions & Findings
...
**ID format.** `GRA-Q<n>` for this unit's own questions; advisory keeps its own
