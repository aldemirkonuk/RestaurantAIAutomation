...
| A future archive tree (`.planning/archive/` deleted 2026-08-24, [[0032-vault-cleanup-cut-line]]) | `status: archived` + `superseded_by` only | Owned by [[corpus-archive-charter]] |
