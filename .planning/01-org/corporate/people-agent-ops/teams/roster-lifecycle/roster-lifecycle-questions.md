...
updated: 2026-08-24
open_questions: 0
links: ["[[roster-lifecycle-charter]]", "[[roster-lifecycle-agenda-full]]", "[[architecture-review-charter]]", "[[red-team-charter]]", "[[decision-office-charter]]"]
---

# Roster & Lifecycle — Questions & Findings
...
**ID format.** `ROS-Q<n>` for this unit's own questions; advisory keeps its own
