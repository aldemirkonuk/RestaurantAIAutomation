...
updated: 2026-08-24
open_questions: 0
links: ["[[taste-fingerprint-charter]]", "[[taste-fingerprint-agenda-full]]", "[[architecture-review-charter]]", "[[red-team-charter]]", "[[decision-office-charter]]"]
---

# Taste Fingerprint (NF-B) — Questions & Findings
...
**ID format.** `TAS-Q<n>` for this unit's own questions; advisory keeps its own
