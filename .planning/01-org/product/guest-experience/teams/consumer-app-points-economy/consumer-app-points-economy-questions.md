...
updated: 2026-08-24
open_questions: 0
links: ["[[consumer-app-points-economy-charter]]", "[[consumer-app-points-economy-agenda-full]]", "[[architecture-review-charter]]", "[[red-team-charter]]", "[[decision-office-charter]]"]
---

# Consumer App & Points Economy — Questions & Findings
...
**ID format.** `CON-Q<n>` for this unit's own questions; advisory keeps its own
