...
groundwork"* (`OD-07, OPEN-DECISIONS.md:36`). Its stated unblocker is *"Founder call after guest MVP
...
1. **OD-07 timing.** Should the option memo be written **now**, or after guest MVP scope
   exists as `OD-07 (OPEN-DECISIONS.md:36)` suggests? This agenda argues *now*, because the memo is
