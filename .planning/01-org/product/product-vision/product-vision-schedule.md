...
| `open-decision-digest` | T2 | Daily | Every open decision has an owner, an age, and a named unblocker; ones without are listed first | `teams/product.md` §6 filed five forks under IDs already in use — OD-20 (OPEN-DECISIONS.md:100), OD-21 (OPEN-DECISIONS.md:127), OD-22 (OPEN-DECISIONS.md:110), OD-23 (OPEN-DECISIONS.md:32), OD-24 (OPEN-DECISIONS.md:121) — the register drifted because nothing read it daily |
