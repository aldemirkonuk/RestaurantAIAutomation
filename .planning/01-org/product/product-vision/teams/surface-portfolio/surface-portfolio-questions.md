...
updated: 2026-08-24
open_questions: 0
links: ["[[surface-portfolio-charter]]", "[[surface-portfolio-agenda-full]]", "[[architecture-review-charter]]", "[[red-team-charter]]", "[[decision-office-charter]]"]
---

# Surface Portfolio — Questions & Findings
...
**ID format.** `SUR-Q<n>` for this unit's own questions; advisory keeps its own
