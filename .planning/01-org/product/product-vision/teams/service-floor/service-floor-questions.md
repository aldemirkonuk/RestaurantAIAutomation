...
updated: 2026-08-24
open_questions: 0
links: ["[[service-floor-charter]]", "[[service-floor-agenda-full]]", "[[architecture-review-charter]]", "[[red-team-charter]]", "[[decision-office-charter]]"]
---

# Service Floor (Floor Checker) — Questions & Findings
...
**ID format.** `SER-Q<n>` for this unit's own questions; advisory keeps its own
