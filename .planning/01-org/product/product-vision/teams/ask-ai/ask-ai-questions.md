...
updated: 2026-08-24
open_questions: 0
links: ["[[ask-ai-charter]]", "[[ask-ai-agenda-full]]", "[[architecture-review-charter]]", "[[red-team-charter]]", "[[decision-office-charter]]"]
---

# Ask AI — Questions & Findings
...
**ID format.** `ASK-Q<n>` for this unit's own questions; advisory keeps its own
