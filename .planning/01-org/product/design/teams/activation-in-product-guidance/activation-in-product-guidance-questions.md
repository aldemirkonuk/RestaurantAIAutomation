...
updated: 2026-08-24
open_questions: 0
links: ["[[activation-in-product-guidance-charter]]", "[[activation-in-product-guidance-agenda-full]]", "[[architecture-review-charter]]", "[[red-team-charter]]", "[[decision-office-charter]]"]
---

# Activation & In-Product Guidance — Questions & Findings
...
**ID format.** `ACT-Q<n>` for this unit's own questions; advisory keeps its own
