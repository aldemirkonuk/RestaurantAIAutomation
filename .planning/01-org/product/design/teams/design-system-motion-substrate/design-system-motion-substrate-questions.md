...
updated: 2026-08-24
open_questions: 0
links: ["[[design-system-motion-substrate-charter]]", "[[design-system-motion-substrate-agenda-full]]", "[[architecture-review-charter]]", "[[red-team-charter]]", "[[decision-office-charter]]"]
---

# Design System & Motion Substrate — Questions & Findings
...
**ID format.** `DES-Q<n>` for this unit's own questions; advisory keeps its own
