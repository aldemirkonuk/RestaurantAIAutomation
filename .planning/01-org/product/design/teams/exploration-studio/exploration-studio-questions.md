...
updated: 2026-08-24
open_questions: 0
links: ["[[exploration-studio-charter]]", "[[exploration-studio-agenda-full]]", "[[architecture-review-charter]]", "[[red-team-charter]]", "[[decision-office-charter]]"]
---

# Exploration Studio — Questions & Findings
...
**ID format.** `EXP-Q<n>` for this unit's own questions; advisory keeps its own
