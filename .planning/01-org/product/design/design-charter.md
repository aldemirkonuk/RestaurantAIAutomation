...
- ✅ **ID collision resolved by [[decision-office-charter]].** `product.md:858-862`
  ...
  OD-20 (analytics spend, `decisions/OPEN-DECISIONS.md:106`),
  OD-21 (Obsidian workflow, `decisions/OPEN-DECISIONS.md:133`),
  OD-22 (tooling library, `decisions/OPEN-DECISIONS.md:116`) and
