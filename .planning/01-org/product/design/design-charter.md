...
- ✅ **ID collision resolved by [[decision-office-charter]].** `product.md:858-862`
  ...
  OD-20 (analytics spend, `decisions/OPEN-DECISIONS.md:125`),
  OD-21 (Obsidian workflow, `decisions/OPEN-DECISIONS.md:152`),
  OD-22 (tooling library, `decisions/OPEN-DECISIONS.md:135`) and
  OD-23 (revenue target, unverified, `decisions/OPEN-DECISIONS.md:36`) — four of the five
