...
updated: 2026-08-24
open_questions: 0
links: ["[[engineering-charter]]", "[[engineering-agenda-full]]", "[[architecture-review-charter]]", "[[red-team-charter]]", "[[decision-office-charter]]"]
---

# Engineering — Questions & Findings
...
**ID format.** `ENG-Q<n>` for this unit's own questions; advisory keeps its own
