...
updated: 2026-08-24
open_questions: 0
links: ["[[catalogue-identity-charter]]", "[[catalogue-identity-agenda-full]]", "[[architecture-review-charter]]", "[[red-team-charter]]", "[[decision-office-charter]]"]
---

# Catalogue & Identity — Questions & Findings
...
**ID format.** `CAT-Q<n>` for this unit's own questions; advisory keeps its own
