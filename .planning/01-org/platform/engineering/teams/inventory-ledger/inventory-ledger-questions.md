...
updated: 2026-08-24
open_questions: 0
links: ["[[inventory-ledger-charter]]", "[[inventory-ledger-agenda-full]]", "[[architecture-review-charter]]", "[[red-team-charter]]", "[[decision-office-charter]]"]
---

# Inventory & Ledger — Questions & Findings
...
**ID format.** `INV-Q<n>` for this unit's own questions; advisory keeps its own
