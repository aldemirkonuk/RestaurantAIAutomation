...
updated: 2026-08-24
open_questions: 0
links: ["[[corpora-enrichment-charter]]", "[[corpora-enrichment-agenda-full]]", "[[architecture-review-charter]]", "[[red-team-charter]]", "[[decision-office-charter]]"]
---

# Corpora & Enrichment — Questions & Findings
...
**ID format.** `COR-Q<n>` for this unit's own questions; advisory keeps its own
