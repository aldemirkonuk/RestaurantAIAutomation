...
updated: 2026-08-24
open_questions: 0
links: ["[[annotation-ground-truth-charter]]", "[[annotation-ground-truth-agenda-full]]", "[[architecture-review-charter]]", "[[red-team-charter]]", "[[decision-office-charter]]"]
---

# Annotation & Ground Truth — Questions & Findings
...
**ID format.** `ANN-Q<n>` for this unit's own questions; advisory keeps its own
