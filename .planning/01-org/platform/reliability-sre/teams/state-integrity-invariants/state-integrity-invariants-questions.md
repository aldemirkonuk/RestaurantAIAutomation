...
updated: 2026-08-24
open_questions: 0
links: ["[[state-integrity-invariants-charter]]", "[[state-integrity-invariants-agenda-full]]", "[[architecture-review-charter]]", "[[red-team-charter]]", "[[decision-office-charter]]"]
---

# State Integrity & Invariants — Questions & Findings
...
**ID format.** `STA-Q<n>` for this unit's own questions; advisory keeps its own
