...
> numbered it **OD-21**, but `.planning/decisions/OPEN-DECISIONS.md:134` already uses
...
- **OD-03 — the harness choice is open.** `NousResearch/hermes-agent` vs
  ...
  (OD-03, `.planning/decisions/OPEN-DECISIONS.md:24`). **This charter does not pick one.**
...
- **OD-04 — external model roster.** No longer stated as downstream of OD-03: the row's
  unblocker is now a **job → model registry** (OD-04, `OPEN-DECISIONS.md:25`).
  → [[model-routing-inference-economics-charter]].
