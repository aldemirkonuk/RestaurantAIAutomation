...
Run the scoped bake-off `OD-03 (OPEN-DECISIONS.md:25)` asks for: hermes-agent vs
...
2. **✅ The fork numbered OD-21 in `technology.md:845` is now `TECH-F3`.** It collided
   with the real OD-21 (Obsidian structural workflow, `OPEN-DECISIONS.md:133`, already
