...
| Adopting a non-Anthropic provider | **No, not yet** | OD-04 is downstream of OD-03 (`OPEN-DECISIONS.md:25`) |
...
6. **Anyone proposes evaluating a non-Anthropic model before OD-03 closes.**
   `OPEN-DECISIONS.md:26` puts OD-04 downstream of the harness choice.
