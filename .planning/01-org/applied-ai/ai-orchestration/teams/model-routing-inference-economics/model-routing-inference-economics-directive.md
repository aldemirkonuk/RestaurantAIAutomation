...
| Adopting a non-Anthropic provider | **No, not yet** | Held here until OD-03 closes; OD-04 (`OPEN-DECISIONS.md:31`) no longer names it as the blocker |
...
6. **Anyone proposes evaluating a non-Anthropic model before OD-03 closes.**
   OD-04 (`OPEN-DECISIONS.md:31`) no longer puts the roster downstream of the harness
