...
Scoped to this repo's actual workloads, per `OD-03 (OPEN-DECISIONS.md:31)`. Its inputs are
...
2. **A date for the OD-03 bake-off.** The method is settled
   (`OD-03, OPEN-DECISIONS.md:31`); the date is not, and [[harness-runtime-premortem]] #1 is
