...
Scoped to this repo's actual workloads, per `OD-03 (OPEN-DECISIONS.md:29)`. Its inputs are
...
2. **A date for the OD-03 bake-off.** The method is settled
   (`OD-03, OPEN-DECISIONS.md:29`); the date is not, and [[harness-runtime-premortem]] #1 is
