...
blocker: "Resolved — the fork is TECH-F3 (02-advisory/decision-office/FORK-REGISTRY.md). technology.md:845 originally numbered it OD-21, which OPEN-DECISIONS.md:151 already spends on the Obsidian structural workflow. A fork that cannot be cited cannot be closed."
```
