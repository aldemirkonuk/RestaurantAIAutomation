...
updated: 2026-08-24
open_questions: 0
links: ["[[security-charter]]", "[[security-agenda-full]]", "[[architecture-review-charter]]", "[[red-team-charter]]", "[[decision-office-charter]]"]
---

# Security — Questions & Findings
...
**ID format.** `SEC-Q<n>` for this unit's own questions; advisory keeps its own
