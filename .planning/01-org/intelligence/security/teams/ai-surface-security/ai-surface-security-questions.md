...
updated: 2026-08-24
open_questions: 0
links: ["[[ai-surface-security-charter]]", "[[ai-surface-security-agenda-full]]", "[[architecture-review-charter]]", "[[red-team-charter]]", "[[decision-office-charter]]"]
---

# AI Surface Security — Questions & Findings
...
**ID format.** `AI--Q<n>` for this unit's own questions; advisory keeps its own
