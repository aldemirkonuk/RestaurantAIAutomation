...
|---|---|---|---|---|---|
| `security-checklist-12c` | T2 | Weekly, and before any board refresh | All fifteen items re-read; each carries a reading or is named `unmeasured`; a metric whose value moved since last run must name what re-measured it | The unguarded-endpoint denominator has been stated four ways — 86 ([[README]]/OD-19 as written) → 103 (`intelligence.md:211-216`, summing module headers) → 94 (row-by-row) → 40 (`OPEN-DECISIONS.md:36`, 2026-08-26). Nobody was reconciling; each number was published as fact | NEW |
...
- **PARTIAL — the numbers themselves, and they have drifted since the charter.** The
  charter's 94 baseline was recounted to 40 in OD-19 (`OPEN-DECISIONS.md:36`,
