...
| The insight count is contested | **Settled at 573** (OD-33, 2026-08-26) — but *only in the register*; nothing in code or CI knows | OD-33, `OPEN-DECISIONS.md:41`; `insight-catalog.spec.ts:9-10` still asserts `>= 200` |
...
**OD-33 settled the count at 573 on 2026-08-26** (OD-33, `OPEN-DECISIONS.md:41`). Two years of
...
And a fourth bucket that must **not** be touched: **citational uses** — OD-33, `OPEN-DECISIONS.md:41`,
