...
updated: 2026-08-24
open_questions: 0
links: ["[[insight-narrative-generation-charter]]", "[[insight-narrative-generation-agenda-full]]", "[[architecture-review-charter]]", "[[red-team-charter]]", "[[decision-office-charter]]"]
---

# Insight & Narrative Generation — Questions & Findings
...
**ID format.** `INS-Q<n>` for this unit's own questions; advisory keeps its own
