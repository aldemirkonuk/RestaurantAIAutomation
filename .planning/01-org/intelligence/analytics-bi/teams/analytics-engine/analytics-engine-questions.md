...
updated: 2026-08-24
open_questions: 0
links: ["[[analytics-engine-charter]]", "[[analytics-engine-agenda-full]]", "[[architecture-review-charter]]", "[[red-team-charter]]", "[[decision-office-charter]]"]
---

# Analytics Engine (Decision Science) — Questions & Findings
...
**ID format.** `ANA-Q<n>` for this unit's own questions; advisory keeps its own
