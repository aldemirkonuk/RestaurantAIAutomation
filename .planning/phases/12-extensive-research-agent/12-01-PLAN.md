...
# Default fields targeted by the eligibility gate (Core 10 — see QUESTIONS.md Q1)
...
# Domain → tier mapping for source classification.
# Domains NOT in this dict are classified as tier-C.
SOURCE_TIER_DOMAINS: dict[str, str] = {
    # Tier-A: producer / official regulatory bodies
    "inao.gouv.fr": "A",
    "ttb.gov": "A",
    "civb.com": "A",
    ...
    "chiantidocg.it": "A",
    # Tier-B: established trade press + wine databases
    "wine-searcher.com": "B",
    "vivino.com": "B",
    "decanter.com": "B",
    "winespectator.com": "B",
