...
**`/orders`** — Three house overlays are built. The manual 'new order' and its guard are owed (fork F5); six legacy modals retire into what is built; two dead files are deleted.
