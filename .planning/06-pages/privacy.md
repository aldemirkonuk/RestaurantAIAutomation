...
migration (OD-27, `.planning/decisions/OPEN-DECISIONS.md:169`).
...
4. Rebrand the 4 strings alongside the auth screens and the verification email, not separately — a notice under one brand describing a product under another is worse than either. *Blocked:* OD-27, deferred by founder pending the full Mudavym migration (OD-27, `.planning/decisions/OPEN-DECISIONS.md:169`).
