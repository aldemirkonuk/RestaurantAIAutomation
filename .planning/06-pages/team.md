...
**`/team`** — Eleven house overlays are built, including the wave's one named exception. The legacy desk's seven surfaces retire with it the day a house's flag turns on; certifications have no house surface (fork F4).
