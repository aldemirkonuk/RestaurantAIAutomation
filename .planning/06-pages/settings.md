...
**`/settings`** — The four location dialogs migrated on 2026-09-04. Two shared dialogs still render legacy inside the rebuilt page — both are questions.
