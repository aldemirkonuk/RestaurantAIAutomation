...
**`/notifications`** — The rebuilt page opens a row in place and has no overlay of its own. The ratified rule is drawn: a one-click approval from the bell opens the panel first.
