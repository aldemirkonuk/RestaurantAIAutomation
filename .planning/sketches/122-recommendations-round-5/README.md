...
> **[2026-09-25 — decided.]** The founder picked **direction B, Goals in the Masthead** (his words:
> *"direction B is better"*; confirmed by `AskUserQuestion` to mean this sketch), against question 1's
> recommendation of A, and took the **recommended** option on every one of questions 2-10 the same day
> (round 5). Recorded in [ADR 0160](../../decisions/0160-the-founders-sketch-review-what-he-valued-and-what-each-page-becomes.md)
> §108 and, for question 2, as an amendment to [ADR 0112](../../decisions/0112-one-modal-policy-three-shapes-one-primitive.md)
> F10. Built on `feat/recs-round6-direction-b`; the page note is `.planning/06-pages/recommendations.md`
> "Round 6". Frontmatter `winner` changed from `null` to `B` by that record; the text below is the sketch
> as the founder reviewed it, unchanged.
