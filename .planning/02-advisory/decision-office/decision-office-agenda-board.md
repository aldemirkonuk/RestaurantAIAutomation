...
- [ ] **One id in two tables.** Open at OD-25 (`OPEN-DECISIONS.md:39`), resolved at
      OD-25 (`OPEN-DECISIONS.md:39`) — the only such row in the file, and **no guard
...
- [ ] **RT-F1 … RT-F6** — staged in `red-team-agenda-full.md:296-301`, namespace
      ...
      and RT-F3 restates OD-26 (`OPEN-DECISIONS.md:40`)
