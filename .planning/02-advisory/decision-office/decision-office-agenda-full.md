...
- **The finding this produces on day one:** **two of the four are red**, and the one
  ...
  pair that agrees is OD-23 (`OPEN-DECISIONS.md:36`).
...
- **Evidence, re-verified 2026-08-28:** `foundation/README.md:269` still assigns
  *"Weekly · Skill health — what fired, what went stale"* to **Research & Math**;
  ...
  OD-25 (`OPEN-DECISIONS.md:37`) records that the 2026-08-24 call fixed the *principle*
...
- **Register defect found in the same pass — filed, not fixed:** **OD-25 appears in both
  tables.** It is open at OD-25 (`OPEN-DECISIONS.md:37`).
  It is also resolved at OD-25 (`OPEN-DECISIONS.md:37`).
...
- **Evidence:** `0036-cost-routing-two-plans-in-harmony.md:24,47`;
  OD-29 (`OPEN-DECISIONS.md:39`); [[decision-office-directive]] §Tie-break rule.
...
- **Evidence, verified 2026-08-28:**
  ...
  OD-106 (`OPEN-DECISIONS.md:68`) is **Design foundation direction**, still open.
  The row that ADR actually closed is
  OD-79 (`OPEN-DECISIONS.md:106`) — *"Resolved 2026-08-26 — enforced"*.
...
1. **OD-25 — Research & Math, Skills, or the Track A4 pair?** Two foundation documents
   ...
   open at OD-25 (`OPEN-DECISIONS.md:37`) while its twin sits resolved
   at OD-25 (`OPEN-DECISIONS.md:37`). One pick closes both.
...
6. **OD-26 — merge triggers org-wide?** Re-measured 2026-08-27 at **23 split triggers vs
   6 merge/retirement** at OD-26 (`OPEN-DECISIONS.md:38`) — the asymmetry widened while
