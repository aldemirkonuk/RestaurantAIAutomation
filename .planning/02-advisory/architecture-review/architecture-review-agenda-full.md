...
- "harness overhead" measured without the messaging surface OD-52 says `base_agent.py`
  ...
  (OD-52, `OPEN-DECISIONS.md:45`) — prices two candidates on different substrates;
...
OD-03 names three candidates (`OPEN-DECISIONS.md:45`); OD-52 reframes the question to
