...
| Producers | `POST /`, `/test`, `/send-email` (~~`/order-approval`, `/low-stock`, `/delivery`, `/price-negotiation`, `/system-alert`~~ closed 2026-09-17, ADR 0147 amendment) | `:191,560,592` (re-measured 2026-09-25; the other rows' lines are as first recorded) |
