...
**Current focus (2026-07-27):** **Testing Campaign (Phases 36–43)** — Phase 36 COMPLETE (registry, rubric, inventory, scorecard, sim-* convention, CI annotations). **Next: `/gsd-discuss-phase 37` or `/gsd-plan-phase 37`** (Synthetic Restaurant Engine). Requirements SYNTH/SIMPOS/BRD/TRUTH/EVAL-AI/JRNY remain open.
