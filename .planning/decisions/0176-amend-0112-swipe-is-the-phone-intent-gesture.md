...
- **Status:** Accepted (founder, 2026-09-19). The founder answered it in session and approved mocks 3e and 3f. It amends the Locked [[0112-one-modal-policy-three-shapes-one-primitive]] in the open (CLAUDE.md §5); 0112's own text is not rewritten. Nothing is built.
- **Date:** 2026-09-19
