...
| 47 | /privacy legal facts (2026-09-18) | his words: "hold as is per now but will be dealt later after the web deployment finishes" — the page keeps its current text; the facts are a fork after the web deployment | OD (to file) |
