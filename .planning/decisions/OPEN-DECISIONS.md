...
| OD-23 | **$20k MRR in 30 days** — the Cowork master plan rates this <10% likely against locked $20–50/mo pricing (400–1,000 restaurants in 30 days) and proposes higher-ACV founder-led sales or counting committed deals instead. | The revenue target drives every Commercial decision; an unreachable one distorts all of them. | Founder call — carried over from `MASTER-PLAN-30-DAY-SPRINT-2026-08-24.md` §0. |
