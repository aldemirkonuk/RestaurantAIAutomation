...
| [0014](0014-proposal-candidate-set-null.md) | `pos_catalog_match_proposals.candidate_inventory_id` gets `ON DELETE SET NULL`, not the mapping's `CASCADE` — a mapping is a claim and dies with its target, a proposal is a question and outlives its answer | 2026-08-25 |
