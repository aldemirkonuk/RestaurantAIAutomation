...
- **Notification preferences.** `ordersMode`, `reportsMode` and `digestFrequency` are
  ...
  **[Built 2026-09-17, same branch.]** The DTO now refuses anything outside
  ...
  house). Migration:
  `20260921090000_a_preference_is_kept_once_per_person_per_house.sql`. The columns
...
- **Recipient routing (OD-121).** **[Built 2026-09-17, founder answer 15 (ADR 0149,
  ...
  `20260921093000_a_daily_summary_can_reach_a_phone.sql`): the daily SMS summary is
  ...
  **[Corrected 2026-09-19, later the same day, CLAUDE.md §5b — the "UNCHANGED"
  ...
  PR)." Built same day:
  `20260921100000_a_low_stock_warning_can_reach_an_inbox.sql` widens
  ...
  `20260921093000`) is not backfilled — the standing rule applies to it too,
  ...
  `20260921093000_a_daily_summary_can_reach_a_phone.sql` gained its own
