...
- **The in-app password change.** Whether `changePassword` revokes other sessions too. The code comment at `auth.service.ts:2216-2223` asks for one rule for both paths; batch 5 answered only the reset.
