...
- **Status:** Proposed 2026-09-18. The founder locks it. Its index row in
  ...
  **Amended 2026-09-19 (round 4)** with a research pass deepening ten still-open
  ...
  (remainder), "Owed: his fine-tuning question"). Also still open: the question as put named the menu line, but (b) also checks the quote P6 cites from a fetched producer or register page; the rule is applied to those spans too, under option A's own words, and whether he meant them is put back to him (Context, "Round 8").
- **Date:** 2026-09-18
...
1. **Does Jev stay the P7(b) claim checker, and how?** Yes, unchanged in shape —
   ...
   he separately asked, carried open for its own round).] **What
...
routing rule; not answered here, carried open for its own round (Q6
...
not retrained** (:2078 below [recomputed 2026-09-21; was :2011, was :1803, was :1743, was :1715]). Concretely, this means pooling and the aggregate guards above (k=5,
...
- **Q1 (remainder) (a) The monthly limit, and (b) the backlog pace.** Every wine sourced costs $1.2k–3.4k a month at
  ...
  - **[Research pass, 2026-09-18: Q1's remainder is SETTLED, not a live fork.**
    ...
    (:2779-2782 [recomputed 2026-09-21; was :2700-2703, was :2481-2484, was :2402-2405, was :2352-2355, was
    :2235-2238, was :2177-2180, stale by this ADR's own earlier edits]), and
    the round-3 diff log states *"Answered: Q1 in full
    (plan credits, no dollar limit)"* (Review trail, :3823 [recomputed
    2026-09-21; was :3706, was :3407, was :3290, was :3235, was :3012, was
    :2981, was :2489]); Q1
    does not appear in this section's own intro list (:2754-2758 [recomputed
    2026-09-21; was :2675-2679, was :2456-2460, was :2377-2381, was :2327-2331, was :2210-2214, was
    :2152-2156]). With Q21 off, "credits allow" now means
    exactly the Max seat's included weekly/session usage — a refused run stops
    and waits for the reset, which is what §11 (:1751-1754, :1777-1781
    [recomputed 2026-09-21; was :1684-1687, :1710-1714, was :1517-1520, :1543-1547, was :1474-1477, :1500-1504, was :1446-1449, :1472-1476, was :1346-1349, :1372-1376])
...
- **Q2 Publication path for inferred cells.** The paths are unchanged:
  ...
  **[Round 3: ANSWERED, (b): *"After automatic checks"*.** One reading to confirm. We
  ...
  - **[Research pass, 2026-09-18: Q2's reading is still open — the top-level
    ...
    (:1318, :2665-2666 [recomputed 2026-09-21; was :1251, :2586-2587, was :1084, :2367-2368, was :1041, :2288-2289, was :1013, :2238-2239, was :932,
    :2191]) picks
    ...
    (to confirm)" as open (:2754-2758 [recomputed 2026-09-21; was :2675-2679, was :2456-2460, was :2377-2381, was :2327-2331,
    ...
    **Recommendation: confirm both gates, don't assume a laxer reading.**
    ...
    stricter reading (G7 at :1294, G6 at :1262 [recomputed 2026-09-21; was :1227, :1195, was :1060, :1048, was :1017, :1005, was
...
- **Q10 Canonical `primary_type`.** The choice is one enum, or three axes.
  **Recommendation:** three axes as cells, with the one-enum slice derived from them.
  - **[Research pass, 2026-09-18: the three-axis recommendation above does
    ...
    the rule at :1043 [recomputed 2026-09-21; was :990, was :855, was :812, was :784, was :723] forbids a model-parsed
    ...
    - *Three axes (the ADR's current text, above)* — colour × effervescence ×
      ...
      boundary rule (:803-808 [recomputed 2026-09-21; was :750-755, was :615-620, was :572-577, was :547-552, was
      :486-491]) that
      sweetness is descriptive and inferable,
      shown "estimated" (P8, :1160 [recomputed 2026-09-21; was :1093, was :946, was :903, was :875, was :794]):
      the never-inferred rule at
      :1043 [recomputed 2026-09-21; was :990, was :855, was :812, was :784, was :723] binds
...
- **Q13 What a sommelier may add** (§1).
  ...
  - **[Research pass, 2026-09-18: confirms (a), and shows why a corroboration
    ...
    **Recommendation stands at (a), cite or don't publish.** It is already
    what §1 (:833-842 [recomputed 2026-09-21; was :780-789, was :645-654, was :602-611, was :577-586, was :516-525]) and §13
    (:1850-1854 [recomputed 2026-09-21; was :1783-1787, was :1612-1616, was :1568-1572, was :1540-1544, was :1440-1444]) implement, so it needs no new
  ...
  **Recommendation:** keep the synchronous read and count it apart. No real house
  ...
  - **[Research pass, 2026-09-18: confirms keeping the synchronous read, with
    ...
    **Recommendation: keep the existing synchronous billed read, counted
    ...
    §11 step 0.21 (the pipeline connector), now at :2443 after this ADR's
    own later edits (recomputed 2026-09-21; was :2376, was :2157, was :2078, was :2028, was :1928,
