...
- **Status:** Proposed 2026-09-18. The founder locks it. Its index row in
  ...
  **Amended 2026-09-19 (round 4)** with a research pass deepening ten still-open
  ...
  settle"). **Amended again 2026-09-21 (round 8)** answering the one fork round
  7 left open: "non-English claims to review" keys on the cited span Jev reads,
  not the claim's own words — his verbatim words, *"review by the menu line"*
  — a decision record only, since no code on this branch, `origin/main`, or the
  cellar lane implements P7(b) yet (§4 P7; Q6 (remainder); Build order 1.5).
  Still Proposed: a second question he asked in the same breath, what approach
  a future fine-tuned checker should take, is owed its own round (Q6
  (remainder), "Owed: his fine-tuning question"). Also still open: the question as put named the menu line, but (b) also checks the quote P6 cites from a fetched producer or register page; the rule is applied to those spans too, under option A's own words, and whether he meant them is put back to him (Context, "Round 8"). **Amended again 2026-09-21 (round 9)** closing both items round 8 left open. **Fine-tuning, his verbatim answer:** *"Word table, gold set, gate"* — no training now; a versioned format-word table used in P7(a) and in routing, reading the raw cited span and failing closed; every reviewer verdict a stored gold row; a language's whole gate opens without a person only once a measured, per-language release gate clears (≥381 person-confirmed false claims at 0 auto-accepted, Wilson z = 1.96, the ADR's own convention); training is a later option only, gated on a named mistake class the table and a catalog still cannot cover at 10+ houses (Context, "Round 9"; Q6 (remainder), the full DECIDED bracket; Build order 1.5a–1.5c). **Scope, his verbatim answer:** *"Yes, any non-English source"* — closes the "put back to him" fork above; the rule reaches the producer or register-page quote P7(b) also checks, not only the menu line. **New this round: Mudavym's own retention** of its review data — *"Everything, 2 years"*, then deleted, including training exports — distinct from OD-133, which is TypeSafe's retention only (§14, a new subsection). Three research-file errors the round's judge found (of six it listed) are corrected, none changing the answer (Q6 (remainder)). Still Proposed: nothing built anywhere for P7(a)'s table, the routing test, gold-row storage or the gate's counters — decision record only (Build order 1.5a–1.5c). [Last call, 2026-09-21: seven corrections to this round's draft, none changing his answers — a third routing condition (a Turkish-specific letter) in neither his answer nor the research is struck and put to him; two merged langdetect measurements separated; 1.5c's boundary check, which could not fail, and the shadow floor (110 with 1 error, not 150) corrected; the mutation-built false claims and the Q17 (i) precondition restored; "his choice was Wilson" narrowed to the option he chose; one open fork added, gold rows ageing out of a released language (§14).] [Last call, second pass, 2026-09-21, read against the `AskUserQuestion` record itself (this session's transcript: the questions, the options and his answers): all three answers are option labels he picked, quoted exactly less a "(Recommended)" tag on two, not words he typed; the fine-tuning option reads *"No training"*, so "training is a later option only" above is the research's staging, not his pick — training at 10+ houses was a separate option, *"Also train our own checker"*, offered and not chosen; only part of the release gate was in the question he answered; the retention option was chosen over the recommended one; and the three research-file corrections are three of the six the judge listed (Q6 (remainder)).] **Amended again 2026-09-21 (rounds 10 and 11)**, closing the three items round 9 left open. **Round 10**, one option label he picked at 20:37, *"Take all three"* (the same "options he picked, not words he typed" convention as round 9's second pass): a raw span holding a Turkish-only letter (ı, ş, ğ, ç, ö, ü, İ) also routes to `review`, reinstating as decided the third OR condition round 9's last call struck and put to him (§4 P7; Build order 1.5a; Q6 (remainder)); and Mudavym's own 2-year retention clock (§14) runs from each row's own date, not one fixed date for the whole set, closing the first gap round 9's second pass left unfilled (Build order 1.5b). Its third item is superseded. **Round 11**, three later direct picks, which govern: *"Keep the counts, not rows"* (21:14), over *"Rolling window"* and *"Back to review"* — a released language's release record keeps the gate's totals and the gold-set version, with no line text, and the language stays released while the 1-in-10 audit's running bound stays under 1%; rows still delete two years from their own date; this closes the fork round 9's last call put to him (§14; Build order 1.5c; Q6 (remainder), item 3). *"Keep it, fail closed"* (21:15) confirms the letter condition, which its option says can be dropped once the gold set measures Turkish; *"All seven"* (21:50) settles the set as ı ş ğ ç ö ü İ (Context, "Round 11"). The window's purpose, which ADR 0118's `retention-rules.ts` rule asks every window to state, is stated plainly (§14): the review data exists to measure and re-check each language's release gate and, if a later decision trains anything, for training exports; the two-year bound is his. One point put to him, not decided: which audits that running bound reads once audit rows reach their own two years (Build order 1.5c). Still Proposed: nothing built anywhere for the letter condition, the row date and deletion, or the release record — decision record only, same as round 9's own table, gold-row storage and gate-counter notes. [Last call, round 10, 2026-09-21: corrections to that round's draft, none changing his answer — three round-9 sentences the draft rewrote are restored, the reinstatement carried in their brackets; 1.5a's letter fixture, which the detector already routes so its mutation could not fail, replaced, and the letters read in either case; 1.5b gains the row date and the deletion the rolling clock needs; the ageing question recorded as round 9's last-call fork, not the second pass's purpose gap (round 11's pick closes it).] **Amended again 2026-09-22 (round 12)** with two more picks, each an option label he picked, quoted less its "(Recommended)" tag, relayed by this round's own brief and read at its last call's second pass against the `AskUserQuestion` record itself, as rounds 9–11 were: both answered at 03:27:43Z on 2026-09-22 (23:27 local the evening before; the round keeps the date its brief gives). **The running bound: *"Running totals"***, over *"Stored records only"* — closes the one point round 11 left open (Context, "Round 11", item 1; §14; Build order 1.5c): the 1-in-10 post-release audit's running false-accept bound is read off a total kept since the language's own release, the same counts-not-rows shape round 11 chose for the release gate itself, not off the audit rows still stored, so a caught false claim keeps counting toward the 1% bound after its own audit gold row's two-year deletion. **ADR 0118's rule: *"Named exception"***, over *"Work out a length"* and *"Change ADR 0118"* — the two-year window is recorded as a named exception to ADR 0118's `retention-rules.ts` rule that retention be tied to a stated purpose, never a round number: its purpose is the one round 11 stated plainly, and its length, two years from each row's own date, is his (*"Everything, 2 years"*, round 9), not derived from that purpose. Written into this ADR; ADR 0118 itself is not edited (Context, "Round 12"; §14). Still Proposed: decision record only, same as every round since 9.
- **Date:** 2026-09-18
...
1. **Does Jev stay the P7(b) claim checker, and how?** Yes, unchanged in shape —
   ...
   set exists, unchanged from Q6 (remainder)'s existing default. **[Round 8,
   2026-09-21: DECIDED — keys on the cited span, not the claim's own words.**
   Founder, verbatim: *"review by the menu line"* (§4 P7's own DECIDED bracket;
   Q6 (remainder)'s, longer, with the full reading and the fine-tuning question
   he separately asked, carried open for its own round).] [Round 9, 2026-09-21: answered — Context, "Round 9".] **What
...
**[Round 8, 2026-09-21: DECIDED.** Founder, verbatim, answering this exact
fork: *"review by the menu line"* — option A, keyed on the cited span, so the
`kdh`-shaped miss (an English claim on a non-English line) now routes to
`review` on this test alone, and a non-English claim on an English line would
not — the distinction keying on the claim's own words could not make. He
separately asked, verbatim: *"but for future when we finetune models, tell me
what approach should we take?"* — a fine-tuning-direction question, not this
routing rule; not answered here, carried open for its own round [round 9, 2026-09-21: answered, Context "Round 9"] (Q6
(remainder), "Owed: his fine-tuning question"). §4 P7 and Q6
(remainder) carry their own DECIDED brackets restating this in the rule's own
words; no code implements P7(b) yet on this branch, `origin/main`, or the
cellar lane (`wt-r5-cellar`, read-only — grepped for `jev`/`typesafe`/
non-English routing terms across `apps/`, `services/`, zero application-code hits in all
three), so the build-order note for whoever writes it lives in Q6
(remainder)'s bracket and in Build order step 1.5.]

### Round 8: which reading of "non-English" (2026-09-21)

Round 7 closed three items and left one fork open for the founder — whether
"non-English claims route to review" keys on the claim's own words or on the
cited span Jev reads (above). Put to him directly this round as *"Non-English
claims to review until the pilot gold set exists: key on the claim's own
words or on the menu line Jev reads?"* (relayed via this round's build brief, which labels it his "round 6" answer of 2026-09-21 —
unlike rounds 2, 3, 5, 6 and 7, not a session-memory file this time). His
answer, verbatim: *"review by the menu line"* — option A, keyed on the cited
span. Read as: a value routes to `review` under P7(b) whenever the cited span
quoted to Jev as `state` (for a listing fact, the menu line) is not confidently English, regardless of the claim value's
own language (§4 P7; Q6 (remainder), DECIDED brackets below). He added,
verbatim, a second and separate question: *"but for future when we finetune
models, tell me what approach should we take?"* — read as fine-tuning
direction for a future checker, distinct from this routing rule. That
research runs separately and is not answered here; recorded as owed, for its
own round (Q6 (remainder), "Owed: his fine-tuning question"). **[Last call, 2026-09-21: one scope point the question did not ask.]** The question named the menu line, but (b) checks every cited span, and for a fact P5–P6 source from the web that span is the quote P6 cites from a fetched producer or register page (§4 P5–P6, P7), not a menu line; a menu line is the span only for a listing fact. Option A keys on the cited span, so the rule is applied to both — an Italian wine's facts quoted from an Italian-language producer page route to `review` until the gold set measures Jev on Italian — and whether he meant the page case too is put back to him rather than assumed either way. **[Round 9, 2026-09-21: DECIDED — yes.** Founder, verbatim: *"Yes, any non-English source"* — the rule reaches beyond the menu line to the producer or register-page quote P7(b) also checks. Full reading at Q6 (remainder)'s new DECIDED bracket; his fine-tuning answer, the question this section left owed, is at Context, "Round 9", below.]**

**Not built anywhere.** No code on this branch, on `origin/main`, or in the
cellar lane (`wt-r5-cellar`, read-only this round — another agent is building
there, not touched) implements P7(b) or its non-English routing; `git grep`
for `jev`, `typesafe` and language-routing terms across `apps/`/`services/`
returns zero hits in application code in all three. This round stays
docs-only: the corrected rule and the exact condition a future implementer
must use are recorded in §4 P7, Q6 (remainder) and Build order step 1.5, for
whichever lane builds P7(b) to pick up.

### Round 9: the fine-tuning question, answered (2026-09-21)

Round 8 left one question owed and one scope point put back to him. Both
close this round. [Last call, second pass, 2026-09-21, read against the `AskUserQuestion` record itself (this session's transcript: the questions, the options and his answers): the three answers below are option labels he picked in two `AskUserQuestion` batches (fine-tuning and retention together; scope beside three unrelated questions), quoted exactly less a "(Recommended)" tag on the first and the third, not words he typed — round 7's convention, "relayed as the option he picked, not a direct quote".]

**Fine-tuning, his verbatim answer: *"Word table, gold set, gate"*.** No
training now. Researched via `ft-judge.md` (`.../scratchpad/q921/`, read in
full — itself reading `ft-methods.md`, `ft-data.md` and `ft-release.md` in
full and running one independent language-detection measurement) plus its
own adversarial pass, which tried to kill the leading approach and could not,
surviving with six amendments folded into the answer below. None of the four
files is copied into this repo — session scratchpad only, `/private/tmp`,
cleared on reboot, the same status `jev-exp.md`/`jev-judge.md` hold (Context,
"Round 7"). Full derivation, the release-gate numbers, the rejected
alternatives and three research-file corrections are at Q6 (remainder)'s new
DECIDED bracket, below.

**Headline:** a versioned format-word table (kdh/kadeh, şişe/sise, yarım
şişe, bardak, karafe) goes into P7(a)'s rule check **and** into routing,
reading the raw cited span and failing closed — the judge's measurement
(`langdetect` 1.0.9) scored the whole raw line `Cloudy Bay, … kdh 350 / sise 1.650 TL` English at 0.99999 (the wine's name outweighs the format word), and scored the raw `kdh 240 / şişe 1.100 TL` Turkish but its cleaned reading `glass 240 / bottle 1.100 TL` English,
so a detector alone misses the first and normalising before routing erases
the second: the table word in the raw span is the signal. A span counts as not-English when the detector is
not confident it is English, **or** it holds a table word; unsure routes to `review`. [Last call, 2026-09-21: the draft merged those two measurements into one and added a third condition, "a
Turkish-specific letter", which is in neither his answer nor the research's fix (`ft-judge.md` §2.1); struck, and put to him rather than assumed.] **[Round 10, 2026-09-21: reinstated.** Founder picked *"Take all three"*, in the same answer as §14's retention clock below: a span holding a Turkish-only letter (ı, ş, ğ, ç, ö, ü, İ) also counts as not-English, a third OR condition, decided, not assumed (Context, "Round 10"). [Last call, 2026-09-21: the draft rewrote round 9's sentence above to include the condition; restored as round 9 wrote it, the reinstatement carried here.] [Round 11, 2026-09-21: confirmed, *"Keep it, fail closed"*, and the set settled, *"All seven"* (Context, "Round 11").]] Every reviewer verdict
becomes a stored, versioned gold row. A language's whole AND gate (rule,
Jev, Opus — never Jev alone) is released from mandatory review only once a
measured, per-language gate clears: at least 381 person-confirmed false
claims with 0 auto-accepted (Wilson, the ADR's own z = 1.96 convention),
from 5 or more houses, blind double-reviewed at kappa ≥ 0.81, with a 1-in-10
post-release audit and a one-flag rollback. Training is a later option only,
gated on a named mistake class the table and a catalog still cannot cover at
10 or more houses. [Last call, second pass, 2026-09-21: that sentence is the research's staging (`ft-judge.md` §4.3), not his pick — the option he chose reads *"No training"*, and training at 10+ houses was the separate option *"Also train our own checker"*, offered and not chosen; any training step is a new question to him and a superseding ADR, not a pre-approved stage.]

**Scope, his verbatim answer: *"Yes, any non-English source"*.** Closes
round 8's own "put back to him" fork (above): the rule is not limited to the
menu line — a producer or official-register page's quote, wherever P7(b)
checks one, routes on the same test.

**New this round: Mudavym's own retention** of its review data — *"Everything,
2 years"*, then deleted, including training exports. Distinct from OD-133,
which is TypeSafe's retention only (§14, a new subsection).

**Not built anywhere**, same check as round 8: zero application-code hits for
`jev`/`typesafe`/language-routing in `apps/` or `services/`, on this branch,
`origin/main` or the cellar lane. This round names the missing steps — the
table's use, routing, gold-row storage, the gate's counters — as Build order
notes (step 1.5a–1.5c), not as code.

### Round 10: the three items round 9 left open (2026-09-21)

Round 9's last call struck a third routing condition rather than assume it (Context, "Round 9") and put to him whether a released language keeps its release once its evidence ages out (§14, "open, not decided"); its second pass recorded the date the two-year clock runs from as a gap, not filled (§14). All three were put to him in one question at 20:37 local (2026-09-22 00:37:40Z), and he picked *"Take all three"* — an option label less its "(Recommended)" tag, not words he typed, the same "options he picked" convention round 9's second pass used. Items (1) and (2) stand. Item (3) was superseded 37 minutes later by his direct pick in round 11, below. The second pass's other recorded gap — how a fixed window squares with `retention-rules.ts`'s rule that retention be tied to a stated purpose, never a round number (ADR 0118; Q18) — was not in this question; round 11 states that purpose, below. [Last call, 2026-09-21: the draft called the ageing question the second of the second pass's two gaps; it was the last call's own open fork, and the gap it displaced is the purpose round 11 states.]

**(1) The Turkish-only-letter condition is reinstated.** A line holding a Turkish-only letter — ı, ş, ğ, ç, ö, ü, İ — also routes to `review`: a third `OR` condition on the not-English test, beside the detector and the format-word table (§4 P7; Build order 1.5a; Q6 (remainder), item 1). It fails safe, the same "unsure routes to `review`" shape the other two conditions already have. Round 9's last call struck this exact condition rather than assume it, because it was in neither his round-9 answer nor `ft-judge.md`'s own fix (Context, "Round 9"); it is now decided, not assumed, and reads the **raw** cited span the same way the table word does. [Last call, 2026-09-21: read as those letters in either case — Ş, Ğ, Ç, Ö and Ü too; İ and ı are listed as they are because their other case, I and i, is English — matched on the span's NFC form, so a decomposed ü (u + U+0308) still counts; NFC changes how a letter is encoded, not which letter it is, so it is not the clean-up round 9 keeps out of routing. A literal match on the seven listed codepoints would miss `ÇANKAYA` (Build order 1.5a, the third fixture).] [Round 11: confirmed twice, and the set settled as all seven (Context, "Round 11", items 2 and 3).]

**(2) The retention clock is rolling.** Mudavym's own 2-year review-data window (§14; *"Everything, 2 years"*, Context, "Round 9") runs from **each row's own date**, not one fixed date applied to the whole set — a row written today is deleted two years from today, a row written next month two years from next month. Closes the first of the two gaps round 9's second pass recorded as not filled (§14); the second, the `retention-rules.ts` purpose rule, is not called closed: round 11 states the window's purpose plainly, below, and the two-year bound stays his. Build order 1.5b carries the row date and the deletion job this clock needs. **[Round 12, 2026-09-22: this second gap is closed — by a *"Named exception"*, not by derivation.** The two-year window is recorded as a named exception to that rule, its purpose stated (round 11) and its length his; written into this ADR, and ADR 0118 is not edited (Context, "Round 12", item 2).]

**(3) Superseded by round 11, before anything was built.** As asked, the third item read a released language's release gate over only the rows still inside their two years. His later direct pick, *"Keep the counts, not rows"* (round 11, item 1), replaces it, and none of it is carried into §14, Build order 1.5c or Q6 (remainder).

### Round 11: his later direct picks, which govern (2026-09-21)

Three more picks the same evening, each an option label he picked, quoted less its "(Recommended)" tag, read against the `AskUserQuestion` record itself (the orchestrating session's transcript: each question, its options and his answer). The first re-asked what round 10's item (3) had already answered — a duplicate question, said here so the later pick is seen to govern rather than to conflict.

**(1) Gold expiry: *"Keep the counts, not rows"*** (21:14 local, 01:14:40Z), picked over *"Back to review"* and *"Rolling window"*. The question: the 2-year retention deletes gold rows, but a language's release gate counts those rows (at least 381 confirmed false claims), so what happens to a released language when its original evidence ages out. The option's own text: *"The release record keeps the totals and the gold-set version, with no line text. It stays released while the 1-in-10 audit stays under 1%."* So: when a language clears its gate, its counters' totals and the gold-set version they were read against are written to a release record with no line text — no cited span, no claim; its gold rows still delete two years from their own date (round 10, item 2); and it stays released while the 1-in-10 audit's running bound stays under 1%, the one revert Build order 1.5c already had — rows ageing out do not revert it. Supersedes round 10's item (3) (§14; Build order 1.5c; Q6 (remainder), item 3). [Open, put to him, not decided: his option names the audit and the 1%, not which audits that running bound reads once audit verdicts, which are reviewer verdicts too, reach their own two years — totals kept since release, the same counts-not-rows shape, or only the audit rows still stored (Build order 1.5c).] **[Round 12, 2026-09-22: closed — *"Running totals"*.** The running bound is read off a total kept since the language's own release, not off the audit rows still stored, so it keeps counting a caught false claim after that claim's own audit gold row is deleted two years on (Context, "Round 12", item 1; §14; Build order 1.5c).]

**(2) Turkish letters: *"Keep it, fail closed"*** (21:15 local, 01:15:06Z), picked over *"Drop it"* and *"Only if unsure"*. The option's own text: *"A Turkish letter alone sends the line to review. This means a few extra reviews, and no Turkish line is auto-accepted by mistake. It can be dropped once the gold set measures Turkish."* Confirms round 10's item (1) a second time; the question had said it also sends English lines naming Turkish producers (Kavaklıdere) to a person. Dropping it once the gold set measures Turkish is a later change to this ADR, not automatic (Build order 1.5a).

**(3) Letter set: *"All seven"*** (21:50 local, 01:50:01Z), picked over *"Only ı ğ ş İ"*: the set is ı ş ğ ç ö ü İ. Round 10's question had listed all seven and the 21:15 question showed only ı ğ ş İ; this pick settles it. The option's own text: *"ı ş ğ ç ö ü İ. Turkish grapes like Öküzgözü and Çalkarası are caught only by ö, ü and ç. German and French lines with ö or ü already go to review through the detector, so the extra cost is small."* [Last call, 2026-09-21: true of Öküzgözü, not of Çalkarası, which also holds ı, so the four letters catch it too; the set stands on Öküzgözü-type names, which the other option's own text says the four letters miss. "Turkish-only" is the 20:37 question's name for the set: ç, ö and ü also occur in French and German lines, and the option's text relies on the detector to route those holding ö or ü.] Its two examples begin with a capital Ö and Ç, the either-case reading round 10's last call gives item (1). Measured this round (`langdetect` 1.0.9, seed 0, an illustration, not a benchmark): a line naming Öküzgözü with no ı, ğ, ş or İ scored English at 0.99999, so only ö and ü catch it (Build order 1.5a, the fourth fixture).

**The 2-year window's purpose, stated plainly.** ADR 0118's `retention-rules.ts` asks every retention window to name its purpose rather than stand as a round number chosen for convenience. This one's: Mudavym's review data exists to measure each language's release gate and to re-check it after release — the gold set and gate he chose in round 9, *"Word table, gold set, gate"* — and, if a later decision trains anything, for the training exports his round-9 retention option names (*"including what trained anything"*; no training is decided). The two-year bound is his (*"Everything, 2 years"*, round 9), not derived from that purpose (§14). The rule's other half, never a round number, is not met by derivation: two years is recorded as his choice, not fitted to the purpose after the fact. With the gate kept as counts at release (item 1), deleting the rows does not end the evidence a released language stands on. **[Round 12, 2026-09-22: closed by naming, not by derivation — *"Named exception"*.** The two-year window is recorded as a named exception to ADR 0118's `retention-rules.ts` rule, this purpose stated and the length his; written into this ADR (Context, "Round 12", item 2; §14), and ADR 0118 itself is not edited.]

**Not built anywhere**, rounds 10 and 11, same check as rounds 8 and 9: `git grep` for `jev`, `typesafe` and language-routing terms across `apps/`, `services/` returns zero application-code hits in this worktree, `origin/main` and the cellar lane (`wt-r5-cellar`, read-only, still another agent's, still not touched). Decision record only — Build order 1.5a gains the reinstated condition and its fixtures, 1.5b the row date and the deletion job, 1.5c the release record, as build-order notes, not code.

### Round 12: the two points round 11 left (2026-09-22)

Two more picks, each an option label he picked, quoted less its "(Recommended)" tag. Relayed to this round by its brief, then read at its last call's second pass against the `AskUserQuestion` record itself, as rounds 9–11 were (the orchestrating session's transcript: each question, its options and his answer): both were put in one batch and answered at 03:27:43Z on 2026-09-22, 23:27 local the evening before; the round keeps the date its brief gives. Each closes a point round 11 left: item 1 the one it put to him (the open bracket in its item 1), item 2 the purpose rule it answered with a purpose but not with a derived length (its "The 2-year window's purpose, stated plainly"). **Not built anywhere**, the same check as rounds 8–11 (Review trail, 2026-09-22): decision record only.

**(1) The running bound: *"Running totals"*.** Picked over *"Stored records only"*. The question restated the audit (it called the bound "a mistake rate over 1%"; the running bound Build order 1.5c names is unchanged), then asked: *"Audit records are deleted after 2 years. What should that 1% be counted over?"* The option's own text: *"Counts kept since release, the same 'counts, not rows' shape you picked before. A mistake keeps counting after its record is deleted."* The option not picked: *"Only audit records still kept. Mistakes stop counting after 2 years, so the check gets weaker as records are deleted."* So: after release, the 1% bound of the 1-in-10 audit is counted over totals kept since the language was released — the same counts-not-rows shape as round 11's *"Keep the counts, not rows"*, which keeps the release gate as counts — not over the audit rows still stored. A mistake the audit catches keeps counting after its own audit record reaches its two-year deletion (round 10, item 2), so deleting aged rows neither lowers nor raises the bound (§14; Build order 1.5c, with its check; Q6 (remainder), item 3).

**(2) The two-year window: *"Named exception"*.** Picked over *"Work out a length"* and *"Change ADR 0118"*. The question: *"Your 'Everything, 2 years' for our own review data is a choice, not worked out. How should we square that?"* The option's own text: *"Keep 2 years, written into ADR 0163 as a named exception to ADR 0118. Cheapest and honest: the purpose is stated and the length stays your call."* The two not picked: *"Replace 2 years with a length worked out from what the release gate and audit actually need."* and *"Amend the rule itself so a founder-chosen round period is allowed."* ADR 0118's `retention-rules.ts` rule is that retention "must be tied to a stated purpose, never to a round number chosen for convenience" (its own words, as Q18 quotes them). Mudavym's own review-data window is recorded as a named exception to that rule, written here and in §14; ADR 0118 is not edited. The exception, whole: its **purpose** is the one round 11 stated — the review data exists to measure each language's release gate and re-check it after release and, if a later decision trains anything, for the training exports his round-9 option names; its **length**, two years from each row's own date (round 10, item 2), is the founder's call (*"Everything, 2 years"*, round 9), not derived from that purpose. It is an exception to this repo's rule only: `retention-rules.ts` grounds that rule in the regimes it names (GDPR Art. 5(1)(e) and KVKK Art. 4(2)(ç) among them), and this ADR decides nothing about those (round 9 chose *"Everything, 2 years"* over *"Ask the lawyer first"*).
...
- **P7 Verify.** A value is auto-accepted as `sourced` only when (a) the deterministic
  ...
  **[Round 8, 2026-09-21: DECIDED — "non-English" keys on the cited span Jev
  reads, not the claim's own words.** Founder, verbatim: *"review by the menu
  line"* (option A), resolving the fork round 7's evidence opened (Context,
  "What this does not settle"; Q6 (remainder), full reading). The rule above is
  corrected in this one respect: a value routes to `review` under (b) whenever
  the cited span handed to Jev as `state` is not confidently English (an undetermined result, a detector error or an empty span included), regardless of the
  claim value's own language — this catches the `kdh` shape (an English claim
  on a non-English line) that keying on the claim would have missed, and would
  not catch the reverse (a non-English claim on an English line), a case round
  7's 216 pooled span claims did not measure: all 28 of its non-English claims cited lines of the two multilingual menus, and no line's own language was ever labelled. **Not built
  anywhere** — checked this worktree, `origin/main` and the cellar lane
  (`wt-r5-cellar`, read-only), zero code hits for `jev`/`typesafe`/language
  routing in `apps/` or `services/`; the build-order condition for whoever
  writes P7(b) is recorded in Build order, step 1.5.] [Last call, 2026-09-21: the span (b) sends is a menu line only for a listing fact; for a fact P5–P6 source from the web it is the quote P6 cites from the fetched page. Option A keys on the cited span, so this test applies to both, and whether his "menu line" meant the page case too is put back to him (Context, "Round 8").] [Round 9, 2026-09-21: DECIDED — yes. Founder, verbatim: *"Yes, any non-English source"*. Confirms, rather than changes, this test as already written: it applies to the producer/register-page quote case above exactly as it applies to a menu line (Q6 (remainder)'s round-9 DECIDED bracket has the fine-tuning answer this same round gives).] [Last call, 2026-09-21: round 9 also fixes what "until the pilot's gold set exists" (round 7's bracket, above) means for routing — a language leaves mandatory `review` only when its release gate clears (Build order 1.5c), measured on the whole (a)∧(b)∧(c) gate, never on Jev alone.] [Last call, second pass, 2026-09-21: nor does round 9 leave the test itself exactly as written — it also reads the **raw** cited span, before any clean-up, and routes to `review` when that span holds a word from the new format-word table even if a detector calls it English, and (a) gains the same table (Build order 1.5a; Q6 (remainder), round-9 fine-tuning bracket). "Confirms, rather than changes" above holds for the scope question only.] **[Round 10, 2026-09-21: DECIDED — a third OR condition, reinstated.** Founder picked *"Take all three"*: a raw span also counts as not-English, and routes to `review`, when it holds a Turkish-only letter (ı, ş, ğ, ç, ö, ü, İ) — round 9's last call had struck exactly this condition rather than assume it; it is now decided (Context, "Round 10"; Build order 1.5a; Q6 (remainder), item 1).] [Round 11, 2026-09-21: confirmed, *"Keep it, fail closed"* — droppable, its option says, once the gold set measures Turkish — and the set settled, *"All seven"*: ı ş ğ ç ö ü İ, read in either case (Context, "Round 11"; Build order 1.5a).]
...
not retrained** (:2159 below [recomputed 2026-09-22; was :2151, was :2127, was :2078, was :2011, was :1803, was :1743, was :1715]). Concretely, this means pooling and the aggregate guards above (k=5,
...
**Mudavym's own retention of its review data.** [Round 9, 2026-09-21,
founder, DECIDED — asked and answered separately from the notice above, on
his fine-tuning question (Q6 (remainder); Context, "Round 9").] Every
reviewer verdict, the gold rows built from them, and anything exported for
training: *"Everything, 2 years"*, then deleted, including training exports.
**This is Mudavym's own retention, not OD-133's** — OD-133 covers only what
TypeSafe retains of prompts sent to Jev (ADR 0182, 2026-09-21 addendum); a
research file this round drew on conflated the two (Q6 (remainder),
correction 3). Stated plainly, per his own answer, and why this round trains
nothing yet: **a model already trained keeps what it learned regardless of
this deletion window** — training writes into weights for good, the same
point this section's own "not retrained" line makes for the pooled-price
models, above. Not built anywhere: no retention job exists yet for review
verdicts or gold rows (Build order 1.5b names the gold-row table this window
would apply to; the retention job itself is not its own named build step
here, since nothing to retain exists before P7(b) does). [Last call, 2026-09-21, open, not decided: the release gate (Build order 1.5c) counts gold rows and this window deletes them after 2 years; whether a released language keeps its release once its evidence ages out, or goes back to `review`, is put to him.] [Last call, second pass, 2026-09-21: the option he picked reads *"Keep all review data for two years, then delete it, including what trained anything. Simpler, but models already trained keep what they learned."* — chosen over the recommended *"Anonymised kept, raw follows house"* and *"Ask the lawyer first"*. Two things it does not say, recorded as gaps, not filled: the date the two years run from, and how a fixed window squares with `retention-rules.ts`'s rule (ADR 0118; Q18 below) that retention be tied to a stated purpose, never a round number — the purpose here is stated (the gold set, the release gate, training exports); the length is his.] **[Rounds 10–11, 2026-09-21: the date gap and the open fork above closed, and the purpose stated.** **The clock is rolling** (round 10, *"Take all three"*) — each row's own date starts its own two years, not one fixed date for the whole set, closing "the date the two years run from"; Build order 1.5b carries the row date and the deletion job. **A released language keeps its release on counts, not rows** (round 11, *"Keep the counts, not rows"*, picked over *"Rolling window"* and *"Back to review"*, superseding round 10's third item) — when a language clears its gate, the counters' totals and the gold-set version are kept in a release record with no line text; its rows still delete on their own dates; it stays released while the 1-in-10 audit's running bound stays under 1% (Build order 1.5c). **The purpose ADR 0118's rule asks for, stated plainly:** this review data exists to measure each language's release gate and re-check it after release (round 9, *"Word table, gold set, gate"*) and, if a later decision trains anything, for the training exports the retention option names; the two-year bound is his, not derived from that purpose. [Open, put to him: which audits that running bound reads once the audit's own rows reach their two years (Build order 1.5c).] Full text: Context, "Round 10" and "Round 11"; §4 P7 and Build order 1.5a carry the letter condition.] **[Round 12, 2026-09-22: both closed.** The open point above: *"Running totals"* — the running bound the 1-in-10 audit reads is a total kept since the language's own release, not the audit rows still stored, so a caught false claim keeps counting after its own audit gold row is deleted two years on (Build order 1.5c). The purpose rule: *"Named exception"* — this window is a named exception to ADR 0118's rule that retention be tied to a stated purpose, never a round number; its purpose is the one stated above, and its length, two years from each row's own date, is the founder's call (*"Everything, 2 years"*), not derived from that purpose. Written here, in this ADR; ADR 0118 is not edited. Full text: Context, "Round 12".]
...
- 1.5 P8 pilot on 200 stratified eligible wines. *Check:* measured cost per wine and
  ...
  the seat it was measured on are recorded here.] [Round 8, 2026-09-21: when P7(b) is
  built here, the non-English-routes-to-review test (§4 P7) must run
  `languageOf(citedSpan)` — the exact quote sent to Jev as `state` — never
  `languageOf(claimValue)`, per the founder's *"review by the menu line"*
  (Context, "Round 8"). No file or function exists yet on this branch,
  `origin/main`, or the cellar lane to point this at (checked, zero application-code hits for
  `jev`/`typesafe` in `apps/` or `services/`); likely lands as a gateway
  service beside `model-client.service.ts`, per §4's existing P7(a)/(b)
  gateway ownership. *Check, once built:* a fixture with a Turkish cited span
  and an English claim value routes to `review`; a fixture with an English
  cited span and an English claim value does not; mutation-tested by swapping
  which string the language detector reads. [Last call, 2026-09-21: the test is fail closed — only a confidently English span passes it; an undetermined result, a detector error or an empty span routes to `review`. A third fixture, a span the detector returns as undetermined (the likely case for a line of names, abbreviations and prices only, such as round 7's Menu B line `Bolly Spec. Cuvée Brut NV, Champ. … gl 24 € / btl 120 €`), routes to `review`, and a second mutation treats an undetermined result as English and must fail. The same test runs on the quote P6 cites from a fetched page, not only on menu lines (§4 P7's last-call bracket).] Not built by this docs-only
  round.] [Round 9, 2026-09-21: **confirmed and extended.** Founder confirms
  the page case too: *"Yes, any non-English source"* — this test already ran
  on the quote P6 cites from a fetched page as well as a menu line (last
  call, above); only his confirmation was open, now closed (Q6 (remainder),
  the round-9 DECIDED bracket). **Three more steps this pipeline has no code
  for yet, named here as build-order notes, not built:**
  - **1.5a Format-word table.** A versioned table (kdh/kadeh, şişe/sise,
    yarım şişe, bardak, karafe) used in P7(a)'s deterministic check and read
    by the routing test above as one of its two OR conditions (detector
    not confident English, OR a table word present). [Last call, 2026-09-21: the draft's third condition, a Turkish-specific letter, is struck — in neither his answer nor `ft-judge.md` §2.1's fix; put to him.] **[Round 10, 2026-09-21: DECIDED — reinstated.** Founder picked *"Take all three"* (Context, "Round 10"): the routing test has three OR conditions — detector not confident English, OR a table word present, OR a Turkish-only letter present (ı, ş, ğ, ç, ö, ü, İ), read in either case on the span's NFC form (Context, "Round 10", item 1). [Last call, 2026-09-21: the draft rewrote round 9's sentence above to three conditions; restored, the change carried here.]] **[Round 11, 2026-09-21: confirmed twice, the set settled.** *"Keep it, fail closed"* keeps the condition, and its option adds that it *"can be dropped once the gold set measures Turkish"* — a later change here, not automatic; *"All seven"* fixes the set as ı ş ğ ç ö ü İ, over the four-letter set (Context, "Round 11").] *Check, once built:* the raw
    line `Cloudy Bay, Sauvignon Blanc, Marlborough, New Zealand, 2023 … kdh 350 / sise 1.650 TL`, which `langdetect` 1.0.9 scored English at 0.99999, routes to `review` on its
    table word, and routing never reads the normalised `glass 240 / bottle 1.100 TL`. Mutation: drop the table-word condition; the
    Cloudy Bay fixture must then fail. [Last call, 2026-09-21: the draft's `kdh 240`-only fixture is not the measured miss; the Cloudy Bay line is.] [Rounds 10–11: a second fixture, once built — the raw line `Sauvignon Blanc, Marlborough, New Zealand, 2023, from the Kavaklıdere cellar, glass 350 / bottle 1.650 TL`, no table word, which `langdetect` 1.0.9 (seed 0) scores English at 0.99999, must route to `review` on its `ı` alone; a mutation dropping the letter condition must then fail it, since nothing but the letter routes it. A third: the same line reading `from the ÇANKAYA cellar` (English at 0.99999, no lowercase listed letter) must route too, and a mutation matching only the seven listed codepoints must fail it. A fourth, for the set he picked: `Single-vineyard Öküzgözü from Eastern Anatolia, a dry red with firm tannins and dark cherry fruit, 2021, glass 300 / bottle 1.400 TL` (English at 0.99999, holding Ö, ö and ü only) must route too, and a mutation narrowing the set to ı ğ ş İ, the option he did not pick, must fail it. [Last call, 2026-09-21, measured: the draft's fixture, a note reading only *"taze ürün"*, scores Turkish at 0.99999 on that same detector, so the detector condition already routes it and dropping the letter condition could not fail it. Round 11 re-measured all three replacement lines the same way — an illustration, not a benchmark.]]
  - **1.5b Gold-row storage.** Every reviewer verdict on a checked claim
    stored as one versioned row: the cited span, the claim, the (a)/Jev/Opus
    scores, an opaque reviewer id, and the gold-set version it belongs to.
    *Check, once built:* a row survives a gold-set version bump unedited, and
    a query by language and by "format swap vs. unstated abbreviation" (the
    release gate's own strata, below) returns it. [Last call, 2026-09-21, round 10's rolling clock: each row also carries its own verdict date, the date its two years run from (Context, "Round 10", item 2), and the deletion that clock needs ships with this table, not after it — §14 left the retention job unnamed, and a clock no job runs keeps every row for good. *Check, once built:* after the job runs, a row a day past its date is gone and a row a day short is kept; a mutation deleting on one fixed date for the whole set must fail.]
  - **1.5c Release gate counters.** Per language: a false-claim count (mutation-built from real lines, each person-confirmed; target
    381 at 0 auto-accepted, Wilson z = 1.96, the ADR's own convention;
    Clopper-Pearson's exact one-sided bound is 299 — the question he answered stated 381, the Wilson figure),
    a house-diversity check (≥5 houses, none over 25%), a stratum check (≥⅓
    format swaps, ≥⅓ unstated abbreviations), a shadow-accept accuracy count
    (Wilson ≥0.95: ≥73 clean, or ≥110 with 1 error; the research's "150 with 1" clears it but is not the floor), and a blind-review kappa
    (≥0.81, Landis-Koch). A language crosses from `review`-only to the
    (a)∧(b)∧(c) gate only when every counter clears; after release, a 1-in-10
    post-accept audit keeps feeding the false-claim counter, and one flag
    reverts the language to `review` if its running bound crosses 1%.
    *Check, once built:* flipping any one counter below its floor keeps the
    language on `review`; at exactly 381 false claims with 0 auto-accepted
    the counter clears and at 380 it does not, and a mutation moving the floor to 380 or to 382 must fail that
    test. [Last call, 2026-09-21: the draft's check removed a 382nd claim, which leaves 381 and must still release, so it could not show the floor.] **[Round 11, 2026-09-21: DECIDED — the gate is counted at release and kept as counts, not rows.** Founder picked *"Keep the counts, not rows"* over *"Rolling window"* and *"Back to review"* (Context, "Round 11"), superseding round 10's third item. When a language clears, a release record is written for it: every counter's totals above and the gold-set version they were read against, with no line text — no cited span, no claim. Its gold rows still delete two years from their own date (1.5b), and that deletion does not revert it: a released language stays released while the 1-in-10 audit's running bound stays under 1%, the one revert above. *Check, once built:* a released language whose 381 gate rows have all passed their own two-year date and been deleted stays released while its audit bound is under 1%; a mutation that recounts the gate from the rows still stored (0, not 381) and reverts it must fail; a mutation writing the cited span or the claim into the release record must fail a check on that record's fields; the audit bound crossing 1% still reverts it; a release record that cannot be read routes the language to `review`, never counts as released. [Open, put to him, not decided: which audits that running bound reads once audit verdicts, which are gold rows too, reach their own two years — totals kept since release, the same counts-not-rows shape, or only the audit rows still stored; his option names the audit and the 1%, not that (Context, "Round 11", item 1).] **[Round 12, 2026-09-22: DECIDED — *"Running totals"*.** The running bound is read off a total kept since the language's own release — the same counts-not-rows shape as the release record above — not off the audit rows still stored, so a caught false claim keeps counting toward the 1% bound after its own audit gold row passes its two-year date and is deleted (1.5b). *Check, once built:* with a caught false claim's audit row past its own two-year date and deleted, the bound still counts it; a mutation that recomputes the bound from the audit rows still stored, rather than the running total, must fail that check; the running total, like the release record, carries no line text — no cited span, no claim (Context, "Round 12", item 1).]]
  Full numbers and the fine-tuning answer they come from: Q6 (remainder),
  the round-9 DECIDED bracket; Context, "Round 9". The letter condition is round 10's answer, confirmed in round 11, and the release record is round 11's: Context, "Round 10" and "Round 11".]
...
- **Q1 (remainder) (a) The monthly limit, and (b) the backlog pace.** Every wine sourced costs $1.2k–3.4k a month at
  ...
  - **[Research pass, 2026-09-18: Q1's remainder is SETTLED, not a live fork.**
    ...
    (:2911-2914 [recomputed 2026-09-22; was :2903-2906, was :2879-2882, was :2779-2782, was :2700-2703, was :2481-2484, was :2402-2405, was :2352-2355, was
    :2235-2238, was :2177-2180, stale by this ADR's own earlier edits]), and
    the round-3 diff log states *"Answered: Q1 in full
    (plan credits, no dollar limit)"* (Review trail, :4079 [recomputed
    2026-09-22; was :4071, was :4047, was :3823, was :3706, was :3407, was :3290, was :3235, was :3012, was
    :2981, was :2489]); Q1
    does not appear in this section's own intro list (:2886-2890 [recomputed
    2026-09-22; was :2878-2882, was :2854-2858, was :2754-2758, was :2675-2679, was :2456-2460, was :2377-2381, was :2327-2331, was :2210-2214, was
    :2152-2156]). With Q21 off, "credits allow" now means
    exactly the Max seat's included weekly/session usage — a refused run stops
    and waits for the reset, which is what §11 (:1832-1835, :1858-1862
    [recomputed 2026-09-22; was :1824-1827, :1850-1854, was :1800-1803, :1826-1830, was :1751-1754, :1777-1781, was :1684-1687, :1710-1714, was :1517-1520, :1543-1547, was :1474-1477, :1500-1504, was :1446-1449, :1472-1476, was :1346-1349, :1372-1376])
...
- **Q2 Publication path for inferred cells.** The paths are unchanged:
  ...
  **[Round 3: ANSWERED, (b): *"After automatic checks"*.** One reading to confirm. We
  ...
  - **[Research pass, 2026-09-18: Q2's reading is still open — the top-level
    ...
    (:1399, :2797-2798 [recomputed 2026-09-22; was :1391, :2789-2790, was :1367, :2765-2766, was :1318, :2665-2666, was :1251, :2586-2587, was :1084, :2367-2368, was :1041, :2288-2289, was :1013, :2238-2239, was :932,
    :2191]) picks
    ...
    (to confirm)" as open (:2886-2890 [recomputed 2026-09-22; was :2878-2882, was :2854-2858, was :2754-2758, was :2675-2679, was :2456-2460, was :2377-2381, was :2327-2331,
    ...
    **Recommendation: confirm both gates, don't assume a laxer reading.**
    ...
    stricter reading (G7 at :1375, G6 at :1343 [recomputed 2026-09-22; was :1367, :1335, was :1343, :1311, was :1294, :1262, was :1227, :1195, was :1060, :1048, was :1017, :1005, was
...
- **Q6 (remainder) The checker licence.** MiniCheck's weights are MIT, but its ANLI
  ...
  - **[DECIDED 2026-09-19, founder (`AskUserQuestion`, item 4 of 12), his own words:
    ...
    **Noted but not asked, for a later fork:** whether Jev's hosted processing of
    ...
    [Round 8, 2026-09-21: **DECIDED — keys on the cited span, not the claim's
    own words.** Founder, verbatim, answering the fork round 7's own evidence
    opened (Context, "What this does not settle"; §4 P7's own DECIDED
    bracket, above): *"review by the menu line"* — option A. A value routes
    to `review` under (b) whenever the cited span handed to Jev as `state`
    is not confidently English, regardless of what language the claim value
    itself is written in; the claim's own language does not enter the test.
    This reading is stricter than keying on the claim in exactly the case
    round 7's experiment found a real miss in: the `kdh` line (Context,
    "Round 7") was an English claim ("costs 240 Turkish lira per carafe")
    quoting a Turkish menu line, so keying on the claim would not have routed
    it, and Opus's rejection alone kept it out of auto-accept; keying on the
    span routes it regardless of what Jev or Opus say. It is looser in the
    opposite case — a non-English claim citing an English span would not
    route on this test — which round 7's data does not speak to either way
    (all 28 non-English claims among the 216 pooled span claims cited lines of the two multilingual menus, B and D, none of English Menu A; no line's own language was ever labelled, and one Turkish claim cites Menu B's `Bolly Spec. Cuvée Brut NV, Champ. … gl 24 € / btl 120 €`, a line of names and English abbreviations a detector may not place at all — corrected at last call from "no such case appeared", which the data cannot show). **Not built
    anywhere.** `git grep` for `jev`, `typesafe`, and non-English/language-
    routing terms across application code (`apps/`, `services/`) returns
    zero hits in this worktree, in `origin/main`, and in the cellar lane
    (`wt-r5-cellar`, read-only — checked, not touched); P7(b) has no gateway
    implementation on any of the three. Build-order note for whoever writes
    it (Build order, step 1.5, carries the same bracket): the language check
    must run on the cited-span string sent to Jev as `state`, never on the
    claim's value string — one language detector, two candidate inputs,
    gated on the span's result alone. Test once built: a Turkish span with
    an English claim routes to `review`; an English span with an English
    claim does not; mutation-test by swapping which string the detector
    reads. `CLAIMS.jsonl`'s `ADR-0163-JEV-LANGUAGE-COVERAGE-UNSTATED` needs
    no change to its `verify` — it checks TypeSafe's stated coverage, not
    this routing mechanics — and stays `open` regardless of which reading
    wins; its `claim` text's background clause is corrected to match this
    round's reading (CLAUDE.md §5b). [Last call, 2026-09-21: "the cited span" is whatever (b) sends — the menu line for a listing fact, the quote P6 cites from a fetched producer or register page for a fact P5–P6 source (§4 P5–P6). The question as put named only the menu line, so the page case is applied under option A's own words and put back to him (Context, "Round 8"), not assumed closed. The test is fail closed: an undetermined result, a detector error or an empty span is not "confidently English" and routes to `review` (Build order 1.5 carries the fixture).]
    **[Round 9, 2026-09-21: DECIDED — yes, any non-English source.** Founder,
    verbatim: *"Yes, any non-English source"* — not only the menu line: the
    producer or official-register page's quote P7(b) also checks (§4 P5–P6)
    routes on the same test, until that language's release gate clears (Build order 1.5c: measured on the whole
    (a)∧(b)∧(c) gate, never on Jev alone) [Last call, 2026-09-21: the draft said "until the gold set measures Jev", against this round's own never-Jev-alone gate]. Confirms, rather than changes, the design §4 P7 and Build order
    step 1.5 already carried.]**
    **Owed: his fine-tuning question (round 8), for its own round:** what approach a
    future fine-tuned checker should take — the founder's own question,
    verbatim: *"but for future when we finetune models, tell me what
    approach should we take?"* Not researched or answered this round;
    recorded so the answer is owed, not dropped — he asked it, so it is
    not a fork this document left unasked; the research runs separately.]
    [Round 9, 2026-09-21: **DECIDED — word table, gold set, gate; no training
    now.** Founder, verbatim, answering the question exactly as he asked it:
    *"Word table, gold set, gate"*. Researched: `ft-judge.md`
    (`.../scratchpad/q921/`), read in full, itself reading `ft-methods.md`,
    `ft-data.md` and `ft-release.md` in full and recomputing every sample-size
    figure in them, plus one independent measurement (`langdetect` 1.0.9 on
    22 hand-picked lines). All three research files converge on the same
    shape — gold set and deterministic fixes first, a small self-hosted model
    last, only if still needed — and the judge's adversarial pass tried to
    kill it and could not, surviving with six amendments folded into the
    answer below. None of the four files is copied into this repo; session
    scratchpad only, cleared on reboot, the same status `jev-exp.md`/
    `jev-judge.md` hold (Context, "Round 7").

    **What changes, none of it built here:**
    1. A short format-word table — kdh/kadeh (glass), şişe/sise (bottle),
       yarım şişe (half bottle), bardak (glass), karafe (carafe); data,
       versioned, extendable per language, never weights — used in P7(a)'s
       deterministic check **and** in the language-routing test itself.
       Routing reads the **raw** cited span, before any clean-up, and fails
       closed. Measured reason, two findings of the judge's own run of `langdetect` 1.0.9 (seed 0):
       the whole raw line `Cloudy Bay, Sauvignon Blanc, Marlborough,
       New Zealand, 2023 … kdh 350 / sise 1.650 TL` scored English at 0.99999 (the wine's name outweighs the format word); the raw `kdh 240 / şişe 1.100 TL` scored Turkish at 0.99999 and its cleaned reading,
       `glass 240 / bottle 1.100 TL`, English at 0.99999 — one detector,
       22 lines, an illustration, not a benchmark, but enough to show a detector alone misses the first and
       normalising before routing erases the second: the table word in the raw span is the signal the rule keys on.
       A span counts as not-English when the detector is not confident it is
       English, **or** it holds any table word; an unsure result routes to `review`. [Last call, 2026-09-21: the draft merged these two measurements into one and added a third condition, any Turkish-specific
       letter, which is in neither his answer nor `ft-judge.md` §2.1's fix; both corrected, the letter condition put to him, not assumed.] **[Round 10, 2026-09-21: DECIDED — reinstated.** Founder picked *"Take all three"*, closing this fork in the same answer as §14's retention clock (Context, "Round 10"): a span holding a Turkish-only letter — ı, ş, ğ, ç, ö, ü, İ, read in either case (Build order 1.5a) — also counts as not-English, a third OR condition. The letter condition is decided, not assumed, and reads the raw span the same way the table-word condition does. [Last call, 2026-09-21: the draft rewrote round 9's sentence above; restored, the change carried here.] [Round 11, 2026-09-21: confirmed, *"Keep it, fail closed"*, droppable once the gold set measures Turkish; the set, *"All seven"* (Context, "Round 11").]]
    2. Every reviewer verdict becomes a stored, versioned, labelled gold row:
       the span, the claim, the rule/Jev/Opus scores, an opaque reviewer id,
       and the gold-set version.
    3. A language's whole AND gate — rule (a), Jev (b) and Opus (c) together,
       **never Jev alone** — accepts without a person only once, per
       language, every one of these holds: [Last call, second pass, 2026-09-21: the question he answered stated part of this gate, "whichever you pick" — 381 confirmed-false Turkish claims from 5+ houses, none auto-accepted, under 1% false-accept, and a 1-in-10 human audit after release; the rest (the 25% cap, the strata, the mutation source, the shadow floor, kappa, the one-flag rollback) is the research's `ft-judge.md` §4.4 design, which his option's *"release each language only when the gate is met"* points to, recorded as that.]
       - **≥ 381** person-confirmed false claims on real lines of that
         language, **0** auto-accepted, from **≥ 5 houses** none over 25% of
         the count, at least a third format swaps and a third unstated
         abbreviations. The false claims are built by deterministic mutation of real lines (swap the kdh and şişe prices, shift the vintage, swap the currency), each confirmed by a person: natural reader errors will not reach 381 at 1–10 houses (`ft-judge.md` §2.2; the adversarial pass's amendment 3). [Last call, 2026-09-21: restored — the draft said all six amendments were folded in and omitted this one.] This is the ADR's own Wilson lower-bound convention,
         z = 1.96 (§9's estimated-value-price gate uses the same z), not the
         one-sided z = 1.645 a research file used for its own n=268 —
         held to the ADR's own convention it needs 381, larger than the
         exact Clopper-Pearson one-sided bound of 299, not smaller. One
         accepted false claim raises the requirement to **563**. **The
         question he answered stated 381, the Wilson figure**, not
         Clopper-Pearson's 299, which the research had listed as an open fork of its own (`ft-judge.md` §5, item 4). [Last call, 2026-09-21: the draft called this "his choice: record it as Wilson"; he chose the option, not the bound by name.]
       - Real shadow claims the gate would accept, person-checked: Wilson
         lower bound ≥ 0.95, needing **≥ 73 with 0 errors, or ≥ 110 with 1**. [Last call, 2026-09-21: recomputed — 110 with 1 error gives 0.9503; the research's "150 with 1" (0.963) clears the floor but is not it.]
       - Gate items reviewed blind by two people, a third settling
         disagreement, Cohen's kappa ≥ 0.81 (Landis-Koch "almost perfect"),
         no label written by the model family under test.
       - After release: **1 in 10** auto-accepted claims still go to a
         person (reusing §5 G6's existing rate); a running false-accept
         bound crossing 1% on those audits flips the language back to
         `review` by one flag. **[Round 11, 2026-09-21: DECIDED — counts, not rows.** Founder picked *"Keep the counts, not rows"* (Context, "Round 11"), superseding round 10's third item: when a language clears, the gate's totals and the gold-set version are kept in a release record with no line text; its gold rows still delete two years from their own date; it stays released while the running bound in the sentence above stays under 1%, and rows ageing out do not revert it (Build order 1.5c, with its one open point).] **[Round 12, 2026-09-22: the open point closed — *"Running totals"*.** The running bound is a total kept since the language's own release, not the audit rows still stored, so it keeps counting a caught false claim after that claim's own audit gold row is deleted two years on (Context, "Round 12", item 1; §14; Build order 1.5c).]
    4. Training is a later option only — gated on a named mistake class
       still holding a large share of review at **10 or more houses**, that
       the table and a producer/appellation catalog still cannot cover. If
       that day comes: a small open multilingual model Mudavym hosts itself,
       LoRA-tuned on person-checked rows with **prices masked**, shadow-run
       first, then added as an extra co-signer that **never accepts alone**. Not before Q17 (i) is answered either: the research's surviving approach trains nothing until Mudavym's own retention (answered this round, below) and Q17 (i) are both settled (`ft-judge.md` §2.6, amendment 5). [Last call, 2026-09-21: restored; the draft carried Q17 (i) only inside the distillation rejection.] [Last call, second pass, 2026-09-21: this item is the research's staging (`ft-judge.md` §4.3), not his pick — his option reads *"No training"*, and this very path, at 10+ houses, was the separate option *"Also train our own checker"*, offered and not chosen (below). Kept so a later round knows when it would be worth asking him again; any training step is a new founder decision and a superseding ADR.]

    **Rejected, with why:**
    - **Also train our own checker** (as offered: the same first steps, then at 10+ houses a small self-hosted open model, prices masked, an extra checker that never accepts alone; its own cost line, *"Adds GPU hosting that doesn't break even at our scale"*). Not chosen. The table fixes the one measured Turkish-line miss (`kdh`) with no labels, no GPU and instant rollback; Jev's other four Menu D misses were
      open-class name abbreviations no table can list, which stay in `review` (abstain on ambiguity; `ft-judge.md` §2.5). [Last call, second pass, 2026-09-21: the draft named this option "Train our own checker now" and called `kdh` "the one measured failure";
      the option offered was training at 10+ houses, and `kdh` was one of Jev's five Menu D misses.]
    - **Copy Opus into a small model** (distilling Opus into a student). Not chosen. In the option's own words it *"copies Opus's blind spots into the check meant to be independent"*:
      a student trained on Opus's verdicts repeats (c)'s errors, and (c) already shares P6's model
      family and is not counted as independent for exactly that reason (§4
      P7, above) — and it sits inside the open question whether training
      Mudavym's own models on the tasks' outputs breaches Anthropic's
      consumer terms (Q17 (i), still unanswered). [Last call, second pass, 2026-09-21: the draft's "the slot (b) and (c) exist to keep independent" corrected.]

    **New this round, asked and answered separately: Mudavym's own
    retention** of its review data — every verdict, the gold rows, anything
    exported for training. Founder, verbatim: *"Everything, 2 years"*, then
    deleted, including training exports. Stated plainly, per his own answer:
    a model already trained keeps what it learned regardless of this
    deletion window, which is part of why nothing trains yet. This is
    Mudavym's own retention, **distinct from OD-133**, which covers only
    TypeSafe's retention of prompts it receives (ADR 0182, 2026-09-21
    addendum) — a research file conflated the two (correction 3, below). Full
    text at §14, a new subsection. [Last call, second pass, 2026-09-21: an option label, chosen over the recommended *"Anonymised kept, raw follows house"* and over *"Ask the lawyer first"*; the option's own text: *"Keep all review data for two years, then delete it, including what trained anything. Simpler, but models already trained keep what they learned."*] **[Rounds 10–11, 2026-09-21: the date gap and the ageing fork §14 records closed, and the purpose stated.** The clock is **rolling** — each row's own date starts its own two years (round 10, *"Take all three"*). A released language keeps its release on counts, not rows (round 11, *"Keep the counts, not rows"*; item 3's bracket, above). The purpose ADR 0118's rule asks a retention window to state: the review data exists to measure and re-check each language's release gate and, if a later decision trains anything, for training exports; the two-year bound is his (§14).] **[Round 12, 2026-09-22: the purpose gap closed by naming, not by derivation — *"Named exception"*.** The two-year window is recorded as a named exception to ADR 0118's rule, its purpose the one stated above and its length his; written into this ADR (Context, "Round 12", item 2; §14), and ADR 0118 itself is not edited.]

    **Three research-file corrections, judged, none changing the answer
    above** (none of the three files is a `CLAIMS.jsonl` row — none is in
    this repo): [Last call, second pass, 2026-09-21: the judge listed six; these are the three that touch a number or a decision recorded here. The other three: `ft-data.md`'s claim-versus-span fork is already decided (round 8); `ft-methods.md` calls `kdh` Jev's one Menu D false accept (it was one of five) and cites P7 at stale lines; `ft-data.md` §9.1's mDeBERTa revisit would need the licence-lineage check MiniCheck got (Q6, above).]
    1. `ft-data.md` §1.3's table gives a Wilson lower bound of 0.916 for 200
       claims with 6 errors; recomputed, it is **0.936**. Its own "does not
       clear 0.95" verdict is unchanged.
    2. `ft-release.md` §2.2's *"Wilson gives n=268"* uses a one-sided z of
       1.645, not the ADR's own convention. Held to z = 1.96, Wilson needs
       **381**, which is larger than the exact Clopper-Pearson one-sided
       bound of 299 — the opposite of what the file implied by comparing an
       inconsistent Wilson figure against Clopper-Pearson.
    3. `ft-release.md` §4.2 names the retention of Mudavym's own
       reviewer-corrected data as OD-133. OD-133 (`OPEN-DECISIONS.md`) is
       TypeSafe's own retention; Mudavym's own retention is this round's new
       answer, above, not OD-133's.

    **Not built anywhere**, re-checked: `git grep` for `jev`, `typesafe` and
    language-routing terms across `apps/`, `services/` returns zero
    application-code hits in this worktree, `origin/main` and the cellar lane
    (`wt-r5-cellar`, read-only). Build order step 1.5 gains three named
    future steps — the table's use and routing, gold-row storage, and the
    release gate's counters — for whoever builds P7(b), not built here.] **[Rounds 10–11, 2026-09-21: re-checked, unchanged** — the letter condition, the row date and deletion, and the release record are decision-record additions to the same three named future steps, not new code (Context, "Round 10" and "Round 11").] **[Round 12, 2026-09-22: re-checked, unchanged** — the running total is a decision-record addition to the same step 1.5c and the named exception is prose in §14, not new code (Context, "Round 12").]
- **Q10 Canonical `primary_type`.** The choice is one enum, or three axes.
  **Recommendation:** three axes as cells, with the one-enum slice derived from them.
  - **[Research pass, 2026-09-18: the three-axis recommendation above does
    ...
    the rule at :1124 [recomputed 2026-09-22; was :1116, was :1092, was :1043, was :990, was :855, was :812, was :784, was :723] forbids a model-parsed
    ...
    - *Three axes (the ADR's current text, above)* — colour × effervescence ×
      ...
      boundary rule (:884-889 [recomputed 2026-09-22; was :876-881, was :852-857, was :803-808, was :750-755, was :615-620, was :572-577, was :547-552, was
      :486-491]) that
      sweetness is descriptive and inferable,
      shown "estimated" (P8, :1241 [recomputed 2026-09-22; was :1233, was :1209, was :1160, was :1093, was :946, was :903, was :875, was :794]):
      the never-inferred rule at
      :1124 [recomputed 2026-09-22; was :1116, was :1092, was :1043, was :990, was :855, was :812, was :784, was :723] binds
...
- **Q11 (remainder) The rest of the houses.**
  ...
  - **[Research pass, 2026-09-18: a clean evidence split among the six, but
    ...
    - All six still have 0 rows in `restaurant_wine_roster` (matches the
      ADR's "stock nothing" claim, :303-305 [recomputed 2026-09-21; was :296-298, was :285-287, was :277-279, was
      :268-270, was :251-253]).
...
- **Q13 What a sommelier may add** (§1).
  ...
  - **[Research pass, 2026-09-18: confirms (a), and shows why a corroboration
    ...
    **Recommendation stands at (a), cite or don't publish.** It is already
    what §1 (:914-923 [recomputed 2026-09-22; was :906-915, was :882-891, was :833-842, was :780-789, was :645-654, was :602-611, was :577-586, was :516-525]) and §13
    (:1931-1935 [recomputed 2026-09-22; was :1923-1927, was :1899-1903, was :1850-1854, was :1783-1787, was :1612-1616, was :1568-1572, was :1540-1544, was :1440-1444]) implement, so it needs no new
  ...
  **Recommendation:** keep the synchronous read and count it apart. No real house
  ...
  - **[Research pass, 2026-09-18: confirms keeping the synchronous read, with
    ...
    **Recommendation: keep the existing synchronous billed read, counted
    ...
    §11 step 0.21 (the pipeline connector), now at :2541 after this ADR's
    own later edits (recomputed 2026-09-22; was :2533, was :2509, was :2443, was :2376, was :2157, was :2078, was :2028, was :1928,
...
- [Round 9] **The fine-tuning research.** `ft-judge.md`'s own stated limits
  carry forward unverified further here: one language-detection library
  (`langdetect` 1.0.9) on 22 hand-picked lines, not a benchmark; the
  500-claims-per-house volume estimate; no vendor fact re-fetched (OpenAI's
  wind-down, Bedrock's Haiku-only route, Introl's break-even, Mistral's
  pricing); no count of public Turkish wine lists; the 1% false-accept target
  is derived from the ADR's own 0.95 sourced floor, not a separate founder
  decision. The three research files (`ft-methods.md`, `ft-data.md`,
  `ft-release.md`) were read by `ft-judge.md`, not independently re-read
  here; this round trusts the judge's own recomputation of their figures
  (Q6 (remainder), the three corrections). Not built, and no CLAIMS row: none
  of the four files is in this repo, so the claims job cannot read them. [Last call, second pass, 2026-09-21: re-checked rather than trusted — 381, 563, 299, 268 (at z = 1.645), 73, 110 and 0.963 recomputed, and 0.936 for 200 claims with 6 errors; `ft-release.md`'s n=268 (:223) and `ft-data.md`'s 0.916 (:139) found where the corrections cite them; `langdetect` 1.0.9 (seed 0) re-run on the three lines quoted, same scores (Cloudy Bay line and `glass 240 / bottle 1.100 TL` English, `kdh 240 / şişe 1.100 TL` Turkish, all at 0.99999); the three answers read against the session transcript's `AskUserQuestion` record.]
...
| 2026-09-21 | Round 8: the one fork round 7 left open, answered directly this round (relayed via this round's build brief, not a session-memory file; the brief labels it the founder's "round 6" answer of 2026-09-21, a different series from this document's own round numbers) | Still Proposed. Closes the fork: *"Non-English claims to review until the pilot gold set exists: key on the claim's own words or on the menu line Jev reads?"* — his verbatim answer, *"review by the menu line"*, option A, keyed on the cited span. He separately asked, verbatim, a second question in the same breath — *"but for future when we finetune models, tell me what approach should we take?"* — read as fine-tuning direction for a future checker, a distinct question this round does not research or answer; recorded as owed, for its own round (Q6 (remainder), "Owed: his fine-tuning question"). **Code search, this round's own work, not carried forward:** `git grep` for `jev`, `typesafe`, and non-English/language-routing terms across `apps/` and `services/` in this worktree, in `origin/main`, and in the cellar lane (`wt-r5-cellar`, read-only — another agent is building there, not touched, not modified) returns zero hits in application code in all three; P7(b) has no gateway implementation anywhere yet (Build order step 1.5 is unbuilt). This branch stays **docs-only**: the routing rule is corrected in the ADR's own text, and the exact condition for whoever eventually builds P7(b) — run the language check on the cited-span string sent to Jev as `state`, never on the claim's own value string — is recorded as a build-order note (step 1.5) for a future lane to pick up, not built here. Amended: the status block; Context ("His four answers" item 1; "What this does not settle", corrected with a DECIDED bracket; a new "Round 8" subsection); §4 P7 (a DECIDED bracket restating the rule in the gate's own words); Q6 (remainder) (a DECIDED bracket with the full reading, the code-search result, and a line for the fine-tuning question, relabelled "Owed" at last call); Build order step 1.5 (the build-order note); `CLAIMS.jsonl` (`ADR-0163-JEV-LANGUAGE-COVERAGE-UNSTATED`'s `claim` text corrected to describe the span-keyed reading — its `verify` is untouched, since it checks TypeSafe's stated coverage, not this routing mechanics, and stays `open` either way); this Review trail. **Self-citation sweep run before commit** (this round's own insertions displace every internal `0163:N` pointer below their anchor points, exactly the drift rounds 4–7 each found): the six insertion points and their exact sizes were read off `git diff -U0`'s own `@@` hunks (not guessed), giving a cumulative-shift function verified self-consistent across all six hunk boundaries; every live self-citation the shift touched — 17 `[recomputed 2026-09-21; was …]` sites found by scanning for the marker text, one already inside the frozen round-4 review-trail row and left untouched per the house rule that record is never silently rewritten — was recomputed and spot-checked by content match at 12 of the 16 live sites (the P7/P8/G6/G7 rule text, the "not retrained" line, step 0.21, the round-3 review-trail row start, the Q1/Q2 founder-answer text, the intro list carrying "Q2's reading (to confirm)", the §1/§13 citation text, and the "stock nothing" claim all landed exactly where the arithmetic predicted), each given a "was :N" hop. Guards re-run and green after every edit in this round, including the sweep: `scripts/check_decision_claims.sh` (414 checked, 414 holding — unchanged, the one `CLAIMS.jsonl` edit touched only `claim` prose, not `verify`); `scripts/check_adr_numbers_unique.py` (1,098 refs checked, no collision, 0163 the only number this document introduces); `scripts/check_od_ids_exist.py` (1,428 documents against 120 register rows, PASS, the same 2 known absorbed-merge notices); `scripts/check_citation_pairing.py` (181 register citations against 121 rows, PASS, unaffected — none of this round's citations point into `OPEN-DECISIONS.md`); `scripts/check_no_conflict_markers.py` (5,500 tracked files plus 1,467 planning documents, PASS). No Python was touched this round, so `ruff`/`black` were not run. No OD row, ADR number, migration, or new CLAIMS row added; one CLAIMS row's prose corrected in place (not added). **Scratchpad experiment reports, reported not copied (retire-to-write does not apply — nothing added to the corpus):** the session scratchpad `.../scratchpad/q921/` still holds `jev-exp.md` (20,603 bytes) and `jev-judge.md` (15,433 bytes), the two files this ADR's Context, "Round 7" cites, plus their supporting directories `jev-exp/` (4.5 MB — `raw/*.jsonl` logs, `docs/` the re-fetched TypeSafe pages, fixtures and analysis scripts) and `jev-judge/` (100 KB — the adversarial re-run's fixtures and scripts). This is `/private/tmp`, a reboot clears it; parked here as a measured fact for the parent to decide whether anything from it should ever be retired-to-written into the repo, not decided by this lane. **[Last call, 2026-09-21: seven corrections before commit, none changing his answer.** (i) Scope: the question named the menu line, but (b) checks every cited span, and for a fact P5–P6 source from the web that span is the quote P6 cites from a fetched producer or register page (§4 P5–P6). Option A keys on the cited span, so the rule is applied to both, and whether he meant the page case is put back to him — added as dated brackets in the status block, Context "Round 8", §4 P7, Q6 (remainder) and step 1.5, not decided here. (ii) Fail closed, stated once and everywhere: only a confidently English span passes; an undetermined result, a detector error or an empty span routes to `review` — Q6's bracket already said "not confidently English" while §4 P7, Context and step 1.5 said "not in English"; step 1.5 gains a third fixture (a span the detector cannot place) and a second mutation (treat undetermined as English). (iii) "No such case appeared in 216 pooled span claims" was more than the data shows: all 28 non-English claims among the 216 cited lines of the two multilingual menus (B, D), but no line's own language was ever labelled, and one Turkish claim cites Menu B's names-and-English-abbreviations line (`jev-exp/probe2_claims.json`, `Q-TR-t4`); corrected in §4 P7 and Q6. The 216 re-derived as 96 + 38 + 37 + 45 (main span set without its 6 unstated-true, both probes, the judge set without its 2 ambiguous). (iv) "Zero hits" is zero in application code: the only matches for `jev`/`typesafe` under `apps/`, `services/` and `packages/`, on this branch and on `origin/main`, are three comment lines in `services/agent-orchestrator/.env.example` (:88, :90, :93), for ADR 0182's prompt gate — step 1.5's flat "zero hits" now says application code too; the cellar lane (read-only, re-grepped with its untracked files included) is building ADR 0193 pricing and menu versions, not P7(b). (v) The fine-tuning question was filed as "Noted but not asked", the label this document uses for forks it left unasked (Q6's notice fork carries it); he asked this one, so it is relabelled "Owed: his fine-tuning question" at all five places. (vi) Round 4's row gains its fifth dated bracket naming this round's shift — the draft above said that row was "left untouched", but the house rule, as rounds 6 and 7 applied it, is a dated bracket, never a silent edit and never silence. (vii) A stray bold marker closing the Context bracket is removed, and `CLAIMS.jsonl`'s row now says "not confidently English" and names the answer's date and batch instead of "round-8 answer". Every one of the 16 live self-citations (58 target lines) was re-verified by content match against `git show HEAD`, 58 of 58 byte-identical, not the draft's 12-of-16 sample; the checker was mutated (one citation moved by one line: FAIL; a range shifted by one: FAIL). These corrections add and remove no line, so no citation moved again. The language-coverage CLAIMS row was mutated once more (a coverage line appended to `TYPESAFE_AI_OVERVIEW.md`: STALE, FAIL; restored byte-identical: 414 of 414 holding). Guards after these edits: `check_decision_claims.sh` 414 checked, 414 holding; `check_adr_numbers_unique.py` 1,099 refs (one more git ref than the draft's run, not a new number), no collision; `check_citation_pairing.py` 181 citations against 121 rows, PASS; `check_od_ids_exist.py` 1,428 documents against 120 rows, PASS; `check_no_conflict_markers.py` 5,500 files plus 1,467 planning documents, PASS.] |
| 2026-09-21 | Round 9: the founder's answers to the two items round 8 left owed or put back to him, dated 2026-09-21 and labelled "round 6" (batches 6f and 6n) in the session record they are relayed from (`AskUserQuestion`, session memory `founder-answers-2026-09-21-round5.md` — a different series from this document's own round numbers), after a fine-tuning research workflow (`ft-methods.md`, `ft-data.md`, `ft-release.md`, judged with an adversarial pass in `ft-judge.md`) | Still Proposed. **His fine-tuning question** (round 8: *"but for future when we finetune models, tell me what approach should we take?"*), answered, verbatim: *"Word table, gold set, gate"* — no training now; a versioned format-word table in P7(a) and in routing on the raw cited span, failing closed; every reviewer verdict a versioned gold row; a language leaves mandatory `review` only when its measured release gate clears (Build order 1.5c). **The scope round 8 put back**, verbatim: *"Yes, any non-English source"* — the rule reaches the producer or register-page quote as well as the menu line. **Mudavym's own retention of review data**, verbatim: *"Everything, 2 years"*, then deleted, including training exports — not OD-133, which is TypeSafe's retention. Amended: the status block; Context ("Round 8" scope bracket; a new "Round 9" subsection); §4 P7 (a round-9 bracket); §14 (a new retention subsection); Build order 1.5 (notes 1.5a–1.5c); Q6 (remainder) (scope and fine-tuning DECIDED brackets, with three research-file corrections); "Not verified" (the research's own limits); every self-citation this round's insertions displaced, each given a "was :N" hop, and round 4's row its sixth dated bracket. No code: P7(b) still has no implementation in application code on this branch, `origin/main` or the cellar lane (`wt-r5-cellar`, read-only). No OD row, ADR number, migration or CLAIMS row added. **Scratchpad research, reported not copied** (retire-to-write; the parent decides): `.../scratchpad/q921/` holds `ft-data.md` (45,063 bytes), `ft-methods.md` (41,816), `ft-release.md` (29,802), `ft-judge.md` (22,094), beside round 7's `jev-exp.md` (20,603), `jev-judge.md` (15,433), `jev-exp/` (4.5 MB) and `jev-judge/` (100 KB); a reboot clears `/private/tmp`. **[Last call, 2026-09-21: seven corrections to the draft, none changing his answers, all made in place so no line moved.** (i) The draft's routing test had a third OR condition, "a Turkish-specific letter", in neither his answer, the session record of it, nor `ft-judge.md` §2.1's fix; struck in Context, 1.5a and Q6, and put to him. (ii) Two `langdetect` measurements were merged into one false sentence (the draft said the raw Cloudy Bay line and "its cleaned reading" both scored English; the cleaned `glass 240 / bottle 1.100 TL` belongs to the raw `kdh 240 / şişe 1.100 TL`, which scored Turkish); separated in Context and Q6, and 1.5a's fixture is now the measured miss, the Cloudy Bay line, with a mutation that drops the table-word condition. (iii) 1.5c's floor check removed a 382nd claim, which leaves 381 and must still release, so it could not fail; now 381 clears, 380 does not, and moving the floor either way must fail. (iv) The shadow floor needs 110 with 1 error (Wilson 0.9503), not 150; 381, 563, 299, 268, 73 and 0.936 were recomputed and hold. (v) The false claims are mutation-built from real lines (`ft-judge.md` §2.2, amendment 3), which the draft omitted while saying all six amendments were folded in; restored in Q6 and 1.5c. (vi) Q17 (i) as a precondition for any training (amendment 5) restored in Q6 item 4. (vii) "His choice: record it as Wilson" narrowed to the option he chose, which carried 381; round 9's own "until the gold set measures Jev" corrected to the whole-gate release, and §4 P7 told what round 7's "until the pilot's gold set exists" now means. One open fork added, not decided: gold rows age out after 2 years, and whether a released language then keeps its release (§14). The 16 live self-citations were re-checked by content against `git show HEAD`, the two the checker cannot parse by hand.] **[Last call, second pass, 2026-09-21: read against the `AskUserQuestion` record itself** (this session's transcript: each question, its options and his answer), not only the memory summary. Nine more corrections, all in place, no line moved, none changing his answers. (i) All three answers are option labels, quoted exactly less a "(Recommended)" tag on two (the fine-tuning and scope options), not words he typed — said once in Context and in the status block, round 7's convention. (ii) The option he chose reads *"No training"*; the draft's "training is a later option only, gated on a named mistake class … at 10+ houses" (status block, Context, Q6 item 4) is the research's staging, and that very path was the separate option *"Also train our own checker"*, offered and not chosen — bracketed in all three places: any training step is a new founder decision and a superseding ADR. (iii) The rejected list named options that were not offered ("Train our own checker now", "Distil Opus into a student"); rewritten to the two offered, with each option's own cost line, and "the one measured failure (`kdh`)" corrected to one of Jev's five Menu D misses. (iv) 381 was in the question's stem ("whichever you pick"), not in the option — (vii) above said "the option he chose, which carried 381"; corrected in Q6 and 1.5c. (v) Only part of the release gate was in front of him (381, 5+ houses, none auto-accepted, under 1%, a 1-in-10 audit); the 25% cap, strata, mutation source, shadow floor, kappa and rollback are marked as the research's §4.4 design his option points to. (vi) Retention: chosen over the recommended *"Anonymised kept, raw follows house"* and *"Ask the lawyer first"*, the option's own text quoted (it is the option, not the ADR, that says models already trained keep what they learned); two gaps recorded, not filled — the date the two years run from, and how a fixed window squares with `retention-rules.ts` (ADR 0118). (vii) "Three research-file errors" was three of the six the judge listed; the other three named in Q6. (viii) Two round-7/8 sentences still said the fine-tuning question was "carried open"; each gains a round-9 pointer. (ix) §4 P7's round-9 bracket said round 9 "confirms, rather than changes, this test as already written"; true of the scope answer only — the same round adds the raw-span reading and the table-word condition, now said there. "Not verified" gains what this pass re-checked: the figures recomputed, `ft-release.md`:223 and `ft-data.md`:139 located, `langdetect` 1.0.9 re-run on the three quoted lines with the same scores.] |
| 2026-09-21 | Round 10: the founder's answer to the three items round 9 left open, 20:37 local (`AskUserQuestion`, the orchestrating session's own transcript), the option picked *"Take all three"* | Still Proposed. One option label he picked, not words he typed — the same "options he picked" convention round 9's second pass used. **(1) The Turkish-only-letter condition, reinstated:** a raw span holding ı, ş, ğ, ç, ö, ü or İ also routes to `review`, a third OR condition beside the detector and the format-word table; round 9's last call had struck this exact condition rather than assume it. **(2) The retention clock is rolling:** Mudavym's own 2-year window (§14) runs from each row's own date, not one fixed date for the whole set, closing the first of the two gaps round 9's second pass recorded. **(3) Superseded by round 11** (next row) before anything was built, and not carried into the design. Amended: the status block; Context (a new "Round 10" subsection); round-10 brackets at Context "Round 9", §4 P7, §14, Build order 1.5a–1.5b and Q6 (remainder) (item 1, the retention paragraph, the re-checked "not built anywhere" note). Its last call's corrections, none changing his answer, all within existing lines: three round-9 sentences the draft rewrote are restored, the reinstatement carried in their brackets; 1.5a's letter fixture, which the detector already routed so its mutation could not fail, replaced, and the letters read in either case on the span's NFC form; 1.5b gains the row date and the deletion job the rolling clock needs; the ageing question recorded as round 9's last-call fork, not the second pass's purpose gap (round 11's pick closes it). No code: none of these answers has any application-code implementation on this branch, `origin/main` or the cellar lane (`wt-r5-cellar`, read-only) — the same `git grep` check rounds 8 and 9 ran. No OD row, ADR number, migration or CLAIMS row added: nothing here is independently checkable code or SQL yet. |
| 2026-09-21 | Round 11: three later direct picks, 21:14, 21:15 and 21:50 local (2026-09-22 01:14:40Z, 01:15:06Z, 01:50:01Z; `AskUserQuestion`, the same transcript), superseding round 10's item (3) | Still Proposed. Each an option label he picked, quoted less its "(Recommended)" tag. **Gold expiry:** *"Keep the counts, not rows"*, over *"Rolling window"* and *"Back to review"* — when a language clears its gate, the totals and the gold-set version are kept in a release record with no line text; rows still delete two years from their own date; the language stays released while the 1-in-10 audit's running bound stays under 1%. The question re-asked what round 10's item (3) had answered; the later direct pick governs, and every rolling-window revert sentence round 10's draft carried is removed (status block, Context, §14, Build order 1.5c, Q6 (remainder) item 3), with the open fork its last call had put to him about refilling the mutation-built 381, which no longer arises. **Turkish letters:** *"Keep it, fail closed"* confirms round 10's item (1); its option says the condition can be dropped once the gold set measures Turkish. **Letter set:** *"All seven"* — ı ş ğ ç ö ü İ, over the four-letter set the 21:15 question had shown. **Purpose:** what ADR 0118's rule asks a retention window to state, stated plainly in §14, not called closed — the review data exists to measure and re-check each language's release gate and, if a later decision trains anything, for training exports; the two-year bound is his. One point put to him, not decided: which audits the running bound reads once audit rows reach their own two years (Build order 1.5c). Build order 1.5a's fixtures: the letter fixture is the measured line this lane's review named (`… from the Kavaklıdere cellar, glass 350 / bottle 1.650 TL`), the either-case fixture reads `from the ÇANKAYA cellar`, and a fourth, an Öküzgözü line holding only ö and ü, kills a mutation to the four-letter set — all three scored English at 0.99999 with `langdetect` 1.0.9 (seed 0); a scratch simulation of the rule (not product code, an illustrative 0.9 bar) routed all four fixtures to `review` and let through an English line holding none of the three signals, and each named mutation failed its fixture — dropping the letter condition fails the three letter fixtures, a codepoint-only match the `ÇANKAYA` one, the four-letter set the `ÇANKAYA` and Öküzgözü ones. **Self-citation sweep (rounds 10 and 11 together):** the one Context insertion (before "## Options considered", at old line 733) adds 24 lines; of the document's 16 live self-citations, 15 target a line below it and are re-pointed +24 from their round-9 value, each gaining one "was :N" hop, content-matched against the edited file; the sixteenth, Q11's "stock nothing" claim (:303-305), is above it and unchanged; round 4's row gains its dated bracket. No code on this branch, `origin/main` or the cellar lane; no OD row, ADR number, migration or CLAIMS row added. Guards re-run on the staged tree — results in this lane's build note, not restated here. [Last call, 2026-09-21: three in-line corrections, no line moved — the *"All seven"* option's text quoted in place of a paraphrase, bracketed that Çalkarası also holds ı and that ç, ö and ü are not Turkish-only; round 10's last-call clause on the ageing answer re-read as the ageing question, which round 11's pick closes; the purpose paragraph's round-number sentence made plain.] |
| 2026-09-22 | Round 12: two more picks, option labels he chose, quoted less a "(Recommended)" tag — relayed by this lane's own brief, then read at the last call's second pass against the `AskUserQuestion` record (answered 03:27:43Z) | Still Proposed. **The running bound:** *"Running totals"*, over *"Stored records only"* — closes the one point round 11 left open in three places (Context, "Round 11", item 1; §14; Build order 1.5c): the 1-in-10 post-release audit's running false-accept bound is read off a total kept since the language's own release, the same counts-not-rows shape round 11 chose for the release gate itself, not off the audit rows still stored — so a caught false claim keeps counting toward the 1% bound after its own audit gold row's two-year deletion. **ADR 0118's rule:** *"Named exception"*, over *"Work out a length"* and *"Change ADR 0118"* — the two-year review-data window, whose purpose round 11 stated plainly but whose length is not derived from it (the rule's "never a round number" half), is recorded as a named exception to ADR 0118's `retention-rules.ts` rule, its purpose stated and its length his, written into this ADR at §14 and Context, "Round 11" and "Round 12"; ADR 0118 itself is not edited. Docs only: no migration, CLAIMS row or OPEN-DECISIONS row is added or changed. `git grep -iE "jev\|typesafe"` across `apps/`, `services/` in this worktree, `origin/main` (fetched) and the cellar lane (`wt-r5-cellar`, read-only) returns the same 3 hits everywhere, all comments in `services/agent-orchestrator/.env.example` (commit `0c1422c8de`, ADR 0182's unrelated coding-agent prompt gate, itself stating "Not used by any agent-orchestrator runtime code today"); a language-routing-terms grep returns 0 hits everywhere. Neither this ADR's P7(b) routing nor its release gate or audit counters are implemented anywhere — decision record only. [Last call, 2026-09-22: corrections before commit, none changing his picks. (i) The draft cited Context, "Round 12" in five places but added no such subsection, on a count of about 250 self-citations to re-point; the live count is 16 — the rest are "was :N" history — so the subsection is added (8 lines, before "## Options considered") and the 15 live self-citations below it are re-pointed +8, each gaining one "was :N" hop, every target range content-matched against the file before the insertion; the sixteenth, Q11's "stock nothing" claim (:303-305), is above it and unchanged; round 4's row gains its dated bracket. (ii) Earlier-round text the draft rewrote is restored and closed by dated brackets instead: §14's open-point bracket and its rounds 10–11 "Full text" pointer, Build order 1.5c's open-point bracket, and Q6 (remainder) item 3's "with its one open point". (iii) The status block and this row said the window's purpose was recorded as the exception; it is the window, its purpose stated and its length his. (iv) Q6 (remainder)'s "not built anywhere" note gains its round-12 re-check.] [Last call, second pass, 2026-09-22, read against the `AskUserQuestion` record itself (the orchestrating session's transcript: each question, its options and his answer): both labels match his answers word for word, each carrying "(Recommended)" in the record, and both were answered at 03:27:43Z on 2026-09-22 (23:27 local on 2026-09-21; the round keeps the date its brief gives). The round's text had claimed no clock time and no rejected option because the record had not been read; the status block and this row now give the time and the options not picked (*"Stored records only"*; *"Work out a length"*, *"Change ADR 0118"*), and Context "Round 12" also gives each question and every option's own text. The question called the bound "a mistake rate over 1%"; 1.5c's running bound is unchanged. Nothing else changes: both picked options' texts match what the round records, and with *"Change ADR 0118"* not picked, ADR 0118 stays unedited. Every edit is inside an existing line, so no self-citation moves.] |
