...
- **Status:** **[LOCKED 2026-09-16 — the founder, in session, via [[0149-mudavym-is-the-only-design-finish-every-page-then-delete-legacy-once]] row 13 (*"Lock 0124, 0126 and 0113"*). Same session, row 17: a decision on a public-register row (no house) gains a new nullable deciding-house column, and the person's name and the undo are shown only inside that house — answered, build in progress (carried with the fault in ADR 0147). The status as written before the lock is kept below.]**
