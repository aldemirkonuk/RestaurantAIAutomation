...
- **Links:** OD-87 (resolved by this), OD-90 + OD-91 (opened by this), [[0020-no-fabricated-answers]], `apps/api-gateway/src/communications/scheduled-tenants.service.ts`
...
- **Left open deliberately:** the crons remain pinned to
  ...
  (3 distinct values in production, including `Europe/Istanbul`) — **OD-90**,
