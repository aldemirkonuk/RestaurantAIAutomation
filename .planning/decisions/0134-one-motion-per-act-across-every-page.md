...
| 2026-09-12 | founder (in session) | Said to land it as **Proposed**: ported from the unmerged `docs/motions-and-overlays-per-page` onto main `beb00db4`; the ten rule changes and all fourteen forks stay open. |
