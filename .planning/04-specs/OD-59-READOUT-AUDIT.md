...
This directly supports the OD-59 framing in `OPEN-DECISIONS.md:55` — *"`context.task_type`
...
`.planning/decisions/OPEN-DECISIONS.md:51` says *"`scripts/nf_readout.py` **refuses**
