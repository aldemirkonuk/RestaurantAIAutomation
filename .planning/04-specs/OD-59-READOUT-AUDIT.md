...
This directly supports the OD-59 framing in `OPEN-DECISIONS.md:97` — *"`context.task_type`
...
`OD-59 (.planning/decisions/OPEN-DECISIONS.md:97)` says *"`scripts/nf_readout.py` **refuses**
