...
CREATE TABLE public.notification_preferences(user_id uuid primary key,email_enabled boolean default true,push_enabled boolean default true,updated_at timestamptz default now());
