...
**Companion document:** `.planning/07-reference/BEVERAGE_CATALOGUE_ARCHITECTURE.md` holds the
...
(`.planning/07-reference/INVENTORY_SOTA_PLAN.md` §1) — and it is *already recurring* in
