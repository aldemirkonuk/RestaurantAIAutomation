...
| [FOOD-REASONING-GRAPH.md](FOOD-REASONING-GRAPH.md) | The seven-layer dependency structure behind "turn food into math"; keystone is transformation (yield + BOM) | Reference (ADR 0048) |
