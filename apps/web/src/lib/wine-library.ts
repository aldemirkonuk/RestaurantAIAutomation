...
export function mapApiWineToUiWine(wine: ApiWine): UiWine {
  return {
    ...
    saleType: (wine as Record<string, unknown>).saleType as UiWine['saleType'] | undefined,
    pourSizeMl: (wine as Record<string, unknown>).pourSizeMl as number | undefined,
    menuPriceGlass: (wine as Record<string, unknown>).menuPriceGlass as number | undefined,
    menuPrice: (wine as Record<string, unknown>).menuPrice as number | undefined,
    provider: {
