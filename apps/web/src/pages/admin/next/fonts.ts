 ...
 *
 * Same pattern as pages/dashboard/next/fonts.ts (not byte-identical — this
 * comment is the difference): the link id matches so whichever page mounts
 * first is the only one that injects the tag.
 */
