    ...
    >
      ...
      <div className="hidden sm:grid grid-cols-2 gap-4">
        ...
        <button
          ...
          style={{ boxShadow: '0 8px 24px rgba(184,50,58,0.3)' }}
        >
    ...
    >
      ...
      <div className="flex items-start mb-7">
        ...
        <div className="flex flex-col items-center gap-1">
          <div className="w-7 h-7 rounded-full bg-wine-600 text-white text-[0.7rem] font-bold flex items-center justify-center shadow-[0_2px_8px_rgba(184,50,58,0.3)]">
            1
          </div>
            ...
            className={[
              ...
              invitePreview?.valid === true
                ...
                : invitePreview?.valid === false
                  ...
                  : 'border-gray-200 focus:border-wine-600 focus:shadow-[0_0_0_3px_rgba(184,50,58,0.08)]',
            ].join(' ')}
            placeholder="········"
            maxLength={8}
            autoFocus
                  ...
                  <div className="flex items-start gap-[9px] py-[7px]">
                    <div
                      className={[
                        ...
                        isActive ? 'bg-wine-600 text-white shadow-[0_2px_6px_rgba(184,50,58,0.35)]' : '',
    ...
    <div className="relative min-h-screen flex items-start justify-center px-4 py-12 overflow-hidden bg-[#FAF7F5]">
      ...
      >
        <div className="text-center mb-8">
          ...
          >
            <BrandMark size={72} className="shadow-[0_12px_40px_-12px_rgba(184,50,58,0.55)]" />
          </motion.div>
        ...
        <AnimatePresence mode="wait" initial={false}>
          {isRestaurantForm ? (
            ...
            <div
              key={stepKey}
              className="rounded-2xl border border-wine-100/80 bg-white/80 backdrop-blur-md p-8 overflow-hidden shadow-[0_24px_64px_-24px_rgba(184,50,58,0.18),0_8px_24px_-12px_rgba(15,23,42,0.08)]"
            >
              {content}
            </div>
          )}
