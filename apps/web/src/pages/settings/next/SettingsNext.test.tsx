...
vi.mock('@/lib/mudavym/useMudavymDesign', () => ({
  ...
  // "SettingsNext — features" below), and that is exactly ALWAYS_ON_PAGES's
  // real membership as of this pass (useMudavymDesign.ts).
  ALWAYS_ON_PAGES: new Set(['settings']),
}));
...
describe('SettingsNext — features', () => {
  ...
  // resolves the redesign for every house in code (ALWAYS_ON_PAGES,
