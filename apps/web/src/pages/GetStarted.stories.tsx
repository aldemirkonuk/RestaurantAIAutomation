    ...
    <div className="max-w-2xl mx-auto p-6 space-y-3">
      ...
      {cards.map((card) => {
        ...
        return (
          ...
          >
            <div className="w-10 h-10 rounded-xl bg-[#9E4249]/10 flex items-center justify-center">
            ...
            <span className="text-sm text-[#9E4249] font-medium inline-flex items-center gap-1">
