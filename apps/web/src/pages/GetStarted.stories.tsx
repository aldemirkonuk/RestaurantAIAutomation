  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-3">
      <div className="text-center mb-6">
        <h1 className="text-2xl font-bold text-gray-900">How to use Mudavym</h1>
      ...
      {cards.map((card) => {
        ...
        return (
          ...
          >
            <div className="w-10 h-10 rounded-xl bg-[#1A5E6B]/10 flex items-center justify-center">
            ...
            <span className="text-sm text-[#1A5E6B] font-medium inline-flex items-center gap-1">
