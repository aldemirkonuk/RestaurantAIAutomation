 ...
 */
type Route = 'inventory-list' | 'inventory-summary' | 'inventory-low-stock' | 'inventory-research' | 'items-to-name' | 'orders' | 'pos-unresolved' | 'storage-locations' | 'pricing-advice' | 'other';
