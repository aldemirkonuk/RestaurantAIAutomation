 ...
 * so in `checkedAt`. This module turns that payload, or the absence of one,
 * into the sentence the page prints. It never guesses: a body it cannot read
 * is reported as a body it could not read.
 */
