...
export function AuthShell({
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center px-4 py-12 overflow-hidden bg-[#FAF8F7]">
      ...
      >
        <div className="text-center mb-8">
          ...
          >
            <BrandMark
              size={markSize}
              className="shadow-[0_12px_40px_-12px_rgba(114,47,55,0.55)]"
            />
          </motion.div>
  ...
  return (
    <div
      className={cn(
        ...
        'shadow-[0_24px_64px_-24px_rgba(114,47,55,0.18),0_8px_24px_-12px_rgba(15,23,42,0.08)]',
        className,
      )}
    >
      {children}
