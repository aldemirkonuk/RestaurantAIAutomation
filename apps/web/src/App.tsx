              ...
              <Routes>
                ...
                */}
                ...
                >
                  ...
                  {/* ADR 0160 §111: resolves to the Mudavym redesign for every
                      house in code (useMudavymDesign's ALWAYS_ON_PAGES) — no
                      `mudavym_design_help` flag exists. `legacy` stays mounted,
