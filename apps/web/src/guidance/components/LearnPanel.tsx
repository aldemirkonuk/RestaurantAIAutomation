...
export function LearnPanel({
  ...
  return createPortal(
    <motion.div
      ...
      className={cn(
        'fixed z-[60] bg-white shadow-xl border-l-4 border-[#B8323A] overflow-hidden flex flex-col',
        isNarrow
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {!task.done && task.cta && (
                    <button
                      ...
                      className="text-xs text-[#B8323A] hover:text-[#D1454C] font-medium mt-0.5"
                    >
                      {task.cta.label} →
                    </button>
                  )}
          ...
          <div className="space-y-0.5">
            {replayableTourIds.map((id: PageTourId) => {
              ...
              return (
                ...
                >
                  <Play className="w-3.5 h-3.5 text-[#B8323A]" />
