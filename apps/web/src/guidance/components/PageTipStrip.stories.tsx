...
function TipStripPreview() {
  return (
    <div
      role="region"
      aria-label="Page tip"
      className="mx-4 mt-4 mb-2 rounded-xl border border-[#722F37]/20 bg-[#722F37]/[0.04] px-4 py-3 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between"
    >
      ...
      <div className="flex flex-wrap items-center gap-2 flex-shrink-0">
        <button
          type="button"
          className="px-3 py-1.5 text-sm font-medium rounded-lg bg-[#722F37] text-white"
        >
          Take 30s tour
        </button>
        <button
