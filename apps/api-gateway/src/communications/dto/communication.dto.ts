import { IsString, IsArray, IsOptional, IsNumber, IsEmail, Min, IsBoolean } from 'class-validator';
...
export class SendEmailDto {
  ...
  @ApiProperty({ description: 'Email subject', example: 'Low Stock Alert: Chateau Margaux 2015' })
  @IsString()
  subject: string;
...
export class SendSmsDto {
  @ApiProperty({ description: 'Phone number in E.164 format', example: '+14155551234' })
  @IsString()
  to: string;

  @ApiProperty({ description: 'SMS message content (max 160 chars recommended)' })
  @IsString()
  message: string;
}
...
export class LowStockAlertDto {
  ...
  @ApiPropertyOptional({ description: 'Recommended order quantity', example: 24 })
  @IsOptional()
  @IsNumber()
  recommendedQty?: number;

  @ApiPropertyOptional({ description: 'Preferred supplier name', example: 'Premium Wine Distributors' })
  @IsOptional()
  @IsString()
  preferredSupplier?: string;

  @ApiPropertyOptional({ description: 'Estimated delivery time', example: '2-3 business days' })
  @IsOptional()
  @IsString()
