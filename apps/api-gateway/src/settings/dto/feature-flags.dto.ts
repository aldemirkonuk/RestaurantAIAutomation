...
export class FeatureFlagsDto {
  ...
  @ApiProperty({
    description:
      "Enable autonomous auto-send of AI vendor replies (default off)",
  })
  @IsBoolean()
...
export class UpdateFeatureFlagsDto {
  @ApiPropertyOptional({
    description: "Enable inventory storage locations feature",
  })
  @IsOptional()
  @IsBoolean()
  enable_inventory_storage_locations?: boolean;
  ...
  @ApiPropertyOptional({
    description: "Enable staff training simulator feature",
  })
  @IsOptional()
  @IsBoolean()
  enable_staff_training_simulator?: boolean;
