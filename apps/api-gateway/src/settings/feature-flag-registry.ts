...
export const ACTIVE_FEATURE_FLAGS: ActiveFeatureFlagSpec[] = [
  ...
  },
  {
    ...
    defaultValue: false,
    readBy: "apps/web/src/lib/mudavym/useMudavymDesign.ts:117",
  },
  {
  ...
  {
    key: "mudavym_design_get_started",
    // OFF by default: the Mudavym redesign of `/get-started`, the activation flow; carries the arrival the founder picks from sketch 104. ADR 0133, column added by
    // 20260907010000.
    defaultValue: false,
    readBy: "apps/web/src/lib/mudavym/useMudavymDesign.ts:117",
  },
  {
    ...
    // OFF by default: the Mudavym redesign of `/promotions` (verdict KEEP+, "more striking"). ADR 0133, column added by
    // 20260907010000.
    defaultValue: false,
    readBy: "apps/web/src/lib/mudavym/useMudavymDesign.ts:117",
  },
  {
    ...
    // OFF by default: the Mudavym redesign of `/vendor-prices` (verdict KEEP+, "more functional"). ADR 0133, column added by
    // 20260907010000.
    defaultValue: false,
    readBy: "apps/web/src/lib/mudavym/useMudavymDesign.ts:117",
  },
  {
    key: "mudavym_design_recommendations_catalog",
    // OFF by default: the Mudavym redesign of `/recommendations/catalog` (verdict KEEP+, more sketches). ADR 0133, column added by
    // 20260907010000.
    defaultValue: false,
    readBy: "apps/web/src/lib/mudavym/useMudavymDesign.ts:117",
  },
  {
    ...
    // OFF by default: the Mudavym redesign of `/logs` (verdict KEEP). ADR 0133, column added by
    // 20260907010000.
    defaultValue: false,
    readBy: "apps/web/src/lib/mudavym/useMudavymDesign.ts:117",
  },
  {
    key: "mudavym_design_help",
    // OFF by default: the Mudavym redesign of `/help` (verdict KEEP). ADR 0133, column added by
    // 20260907010000.
    defaultValue: false,
    readBy: "apps/web/src/lib/mudavym/useMudavymDesign.ts:117",
  },
  {
    ...
    // OFF by default: the Mudavym redesign of `/admin` (verdict KEEP; owner-only route). ADR 0133, column added by
    // 20260907010000.
    defaultValue: false,
    readBy: "apps/web/src/lib/mudavym/useMudavymDesign.ts:117",
  },
  {
    key: "mudavym_design_admin_health",
    // OFF by default: the Mudavym redesign of `/admin/health` (verdict KEEP; owner-only route). ADR 0133, column added by
    // 20260907010000.
    defaultValue: false,
    readBy: "apps/web/src/lib/mudavym/useMudavymDesign.ts:117",
  },
  {
    ...
    // OFF by default: the Mudavym redesign of `/authorize/:integrationId`, the consent page (verdict KEEP). ADR 0133, column added by
    // 20260907010000.
    defaultValue: false,
    readBy: "apps/web/src/lib/mudavym/useMudavymDesign.ts:117",
  },
  {
    key: "mudavym_design_ask",
    // OFF by default: the Mudavym redesign of `/ask`, where the house answers as Mudavym — a NEW route (ADR 0133 §Decision 2–3); OFF redirects, the surface does not exist here. ADR 0133, column added by
    // 20260907010000.
    defaultValue: false,
    readBy: "apps/web/src/lib/mudavym/useMudavymDesign.ts:117",
  },
