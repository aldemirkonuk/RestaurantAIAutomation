...
export const ACTIVE_FEATURE_FLAGS: ActiveFeatureFlagSpec[] = [
  ...
  },
  {
    ...
    defaultValue: false,
    readBy: "apps/web/src/lib/mudavym/useMudavymDesign.ts:93",
  },
  {
  ...
  },
  {
    ...
    // one flag — see that migration's own note. The nine other pages ADR
    // 0133 covers are not part of this addition.
    defaultValue: false,
    readBy: "apps/web/src/lib/mudavym/useMudavymDesign.ts:93",
  },
];
