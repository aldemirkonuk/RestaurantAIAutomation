...
describe('DashboardController', () => {
  ...
  describe('GET /dashboard/activity/:restaurantId', () => {
    ...
    it('should return activity feed', async () => {
      ...
      expect(mockDashboardService.getActivity).toHaveBeenCalledWith(restaurantId, 20);
    });
    ...
    it('should accept limit query parameter', async () => {
      ...
      expect(mockDashboardService.getActivity).toHaveBeenCalledWith(restaurantId, 50);
    });
  ...
  describe('GET /dashboard/sales-chart/:restaurantId', () => {
    ...
    it('should return sales chart data with default period', async () => {
      ...
      expect(mockDashboardService.getSalesChart).toHaveBeenCalledWith(restaurantId, 'month');
    });
    ...
    it('should accept period query parameter', async () => {
      ...
      expect(mockDashboardService.getSalesChart).toHaveBeenCalledWith(restaurantId, 'week');
    });
    ...
    it('should handle different period values', async () => {
      ...
      for (const period of periods) {
        ...
        expect(mockDashboardService.getSalesChart).toHaveBeenCalledWith(restaurantId, period);
      }
    });
  });
  ...
  describe('GET /dashboard/inventory-breakdown/:restaurantId', () => {
    ...
    it('should return inventory breakdown', async () => {
      ...
      mockDashboardService.getInventoryBreakdown.mockResolvedValue(expectedResponse);
      ...
      expect(mockDashboardService.getInventoryBreakdown).toHaveBeenCalledWith(restaurantId);
    });
    ...
    it('should throw INTERNAL_SERVER_ERROR on service failure', async () => {
      ...
      await expect(controller.getInventoryBreakdown(restaurantId)).rejects.toThrow(
        new HttpException('Database error', HttpStatus.INTERNAL_SERVER_ERROR),
      );
    });
  });
