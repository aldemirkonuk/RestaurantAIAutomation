...
3. **Copy Migration Script**
   ...
   - Open file: `md/02-architecture/FULL_MIGRATIONS.sql`
...
# Run migration
supabase db push --file md/02-architecture/FULL_MIGRATIONS.sql
```
...
- Migration file: `md/02-architecture/FULL_MIGRATIONS.sql`
