...
**5 documents read; 9 named invariant failure(s); 6 of 16 invariants UNTESTABLE on every document (18 lines extracted in total)**
...
| `deposits_coded_and_excluded` | — | 4 | 2 | 1 |
...
| `total_with_vat` | — | 2 | 2 | 1 |
| `total_without_vat` | — | 0 | 0 | 5 |
| `vat_breakdown_present` | — | 0 | 4 | 1 |
| `vat_category_tax_amount` | — | 0 | 0 | 5 |
| `vat_category_taxable_base` | — | 0 | 0 | 5 |
| `vat_total_matches_breakdown` | — | 0 | 0 | 5 |
...
| --- | --- | --- | --- | --- |
| `5c7d4801-884c-482b-97eb-3b7d405b39cb` | `vat_breakdown_present` | at least one VAT breakdown row | 0 | The document states 253.58 of VAT with no breakdown, so no category's base can be checked. |
| `b1e02edf-e696-4c93-8c41-a3433873c8dd` | `total_with_vat` | 11366.4 | 11186.4 | 9532.00 plus VAT 1834.40 gives 11366.40, but the document states 11186.40. |
| `b1e02edf-e696-4c93-8c41-a3433873c8dd` | `vat_breakdown_present` | at least one VAT breakdown row | 0 | The document states 1834.40 of VAT with no breakdown, so no category's base can be checked. |
| `b1e02edf-e696-4c93-8c41-a3433873c8dd` | `deposits_coded_and_excluded` | a document-level charge (BG-21) with a UNCL7161 reason code | an invoice line inside BT-106 | Line 4 reads as a deposit but is billed as a goods line, so it is inside the goods total and will inflate beverage cost every month it recurs. |
