...
sys.path.insert(
    0,
    "/Users/aldemirkonuk/Desktop/Unicorn Projects - /Restaurant AI Automation/services/agent-orchestrator",
)
...
def test_supabase_cron():
    ...
    print(
        "   2. Run the migration script: md/02-architecture/SUPABASE_CRON_SETUP.sql"
    )
