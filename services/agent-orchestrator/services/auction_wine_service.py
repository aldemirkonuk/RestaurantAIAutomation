    ...
    async def _query_openai(self, wine_name: str) -> Dict:
        ...
        try:
            response = await asyncio.to_thread(
                ...
                messages=[
                    {"role": "system", "content": "You are a wine expert specializing in wine identification and classification."},
            ...
            # Parse response
            result = self._parse_ai_response(response.choices[0].message.content, wine_name)
            return result
