...
def mock_anthropic_response():
    ...
    resp.content[0].text = (
        '{"wines": [{"wine_name": "Barolo", "vintage": 2018, "price_bottle": 120.0, "price_glass": null, "region": "Piedmont", "country": "Italy", "grape_variety": "Nebbiolo", "section_name": "Reds", "bin_number": null}], "page_notes": "test", "total_wines_extracted": 1}'
    )
