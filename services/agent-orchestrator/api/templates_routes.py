...
class TemplateCreate(BaseModel):
    ...
    category: str = Field(
        ..., description="Category: order, inquiry, confirmation, follow_up"
    )
    ...
    restaurant_id: Optional[str] = Field(
        None, description="Restaurant ID (null for global)"
    )
...
async def preview_template(request: TemplatePreview):
    ...
    try:
        ...
        rendered = await manager.preview_template(
            template_body=request.body, sample_variables=request.sample_variables
        )
...
async def list_common_variables():
    ...
    variables = [
        ...
        {"name": "manager_name", "description": "Manager name", "example": "Jane Doe"},
        {
            ...
            "example": "Château Lafite Rothschild 2018",
        },
        ...
        },
        {
            ...
            "example": "Please deliver before 2pm",
        },
    ]
